...
thname("หมอ") "หมอเกรงว่านี่คือสิ่งที่ดีที่สุดที่หมอจะทำได้แล้ว"
...
thname("หมอ") "จะได้ย้ายไปที่โรงเรียนยามากุที่จัดตั้งมาสำหรับนักเรียนพิการ"
...
thname("หมอ") "ก็ไม่ต่างอะไรกับโรงเรียนกินนอนหรอก ออกแบบมาให้นักเรียนมีอิสระพอตัวไปพร้อม ๆ กับที่มีคนคอยดูอยู่ตลอดด้วย" #possibly longest text for Thai before slash n
...
thname("พ่อ") "แม่กับพ่อก็ไปดูมาเมื่อสองสามอาทิตย์ก่อนแล้ว ลูกน่าจะชอบนะ"
...
thname("หมอ") "เพื่อนร่วมงานหมอคนนึงที่อยู่อีกโรงพยาบาลก็จบจากที่นั่น"
...
mu "เห็นหัวหน้าเจ้าหน้าที่พยาบาลบอกให้เธอแวบไปตรวจร่างกายครั้งแรกหน่อยด้วย แต่ไว้ทีหลังแล้วกัน"
...
"ฉันเหลือบไปเห็นคนหนึ่งที่มีผมสีเข้มที่มองมาทางนี้ ผู้หญิงผมตรงยาวที่ค่อนข้างสะดุดตา\nพอเห็นว่าฉันมองอยู่ก็เอามือปิดหน้าเหมือนกับว่าทำแล้วจะล่องหนได้"
...
"ทั้งสองคนชี้บอกห้องของนักเรียนปีสุดท้ายคนอื่น ๆ ที่อยู่ชั้นเดียวกับห้องเราพลางพาฉันเดินไปตามกลุ่มคนลงมาตามบันได"
...
mi "แต่ก็นั่นแหละ สำนักงานเจ้าหน้าที่พยาบาลอะไรอยู่ในนั้นหมด ส่วนห้องหัวหน้าพยาบาลอยู่ที่ชั้นแรก"
...
"บนประตูสีขาวมีเครื่องหมายบวกสีเขียวอยู่กับข้อความ “หัวหน้าพยาบาล” พร้อมป้ายชื่อ"
