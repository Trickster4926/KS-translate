...
ke "ฉันไม่เข้าเรียน ฉันต้องรอพิซซ่ามาส่งแล้วจ่ายเงินแล้วก็กิน ไม่ง่ายนะเว้ย ต้องแอบไปเอาพิซซ่าแบบเงียบ ๆ ไม่งั้น\nเดี๋ยวมีคนมาเห็นนายแล้วมาขอแบ่งอีก"
...
ke "โลกนี้อยู่ยากจริง ๆ ว่ะ ทุกคนก็มาขอแบ่ง ท้ายที่สุดนายก็จะถูกปล่อยให้ไร้พิซซ่าในโลกที่โหดร้าย ที่ฉันรู้เพราะว่า\nเคยเจอมาก่อนไง"
...
ke "นายไม่ควรมาจ้ำจี้เรื่องเงินขนาดนี้นะ เนี่ยแค่เกิดเป็นผู้ชายก็แย่มากพอละ รู้เปล่าว่าดาราหนังโป๊เนี่ยผู้ชายทำเงินได้แค่\nครึ่งเดียวของผู้หญิงเองนะ"
...
ke "ไม่แน่ฉันอาจจะเป็นก็ได้ เป็นดาราหนังโป๊ที่ต้องดิ้นรนหาเลี้ยงชีพขณะที่ต้องสู้กับแนวคิดสตรีนิยมแล้วนายก็ไม่เห็นหัวฉันด้วยซ้ำ\nแม่งเอ๊ย ไม่มีใครเข้าใจฉันเลย ไม่มีเลย"
...
li "ฉันก็คุยเรื่องงบประมาณไปแล้วก่อนเธอจะมาอีกนะ เธอคงจะเก่งมาก ๆ เลยสินะ เลยสามารถจะรีบจัดการงานสภานักเรียนของ\nเธอจนหมด เพื่อที่จะได้มาตามจี้ฉันเพื่อให้ฉันไม่ลืมเรื่องนี้น่ะ"
