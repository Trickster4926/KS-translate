...
ke "ไม่แน่ฉันอาจจะเป็นก็ได้ เป็นดาราหนังโป๊ที่ต้องดิ้นรนหาเลี้ยงชีพขณะที่ต้องสู้กับแนวคิดสตรีนิยมแล้วนายก็ไม่เห็น\nหัวฉันด้วยซ้ำ แม่งเอ๊ย ไม่มีใครเข้าใจฉันเลย ไม่มีเลย"
...
hi "ไม่เห็นเลย ปกติเห็นเธอจะมาช่วงก่อนระฆังเข้าคาบดังไม่นาน… หรือไม่ก็มาหลังจากนั้น อยากจะฝากฉันบอกอะไรให้\nเธอไหมล่ะ?"
