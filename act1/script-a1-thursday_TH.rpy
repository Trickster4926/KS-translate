...
"เสียงนาฬิกาปลุกดังปลุกฉันจากการนอนหลับไม่สนิทให้ตื่นขึ้นมาอย่างหมดแรง"

"ฉันมุดตัวอยู่ในผ้าห่มอีกสักพักรวบรวมแรงเพื่อลุกออกจากเตียงพลางแก้ตัวว่าทำไมยังไม่ลุกออกจากเตียง"

"ที่จริงจะนอนอยู่อย่างนี้ทั้งวันเลยก็ได้ พอไม่ได้มาโรงเรียนนานแล้วกลับมาอีกทีก็ทำเอาเพลียได้อย่างเหลือเชื่อ\nและเหมือนจะยังไม่ชินกับสภาพแวดล้อมแบบนี้เท่าไหร่ด้วย"
...
"ยังไงซะ ถ้าจะเริ่มดูแลตัวเองก็คงจะขี้เกียจไม่ได้ละ ต้องเริ่มจากอะไรง่าย ๆ ก่อน"
...
"ฉันละอยากรู้ว่าทำไมถึงต้องมาวิ่งแต่เช้าตรู่ขนาดนี้ บางทีเหตุผลอาจจะคล้าย ๆ ฉันแหละมั้ง แบบคุณพยาบาล\nบีบบังคับให้สาวน้อยที่น่าสงสารต้องมาวิ่งเหมือนอย่างที่บังคับฉันมา"

"ถ้าไม่ใช่ว่าเป็นเรื่องสุขภาพฉันกับที่คุณพยาบาลสั่งให้ฉันมาฉันคงไม่มาหรอก"
...
"เอมิทำท่าจะรู้สึกผิดไปแวบหนึ่งก่อนจะหัวเราะคิกคักออกมา"
...
hi "ไม่หรอก ฉันไม่แน่ใจด้วยซ้ำว่าจะชอบวิ่งขนาดนั้นไหม"
...
"เธอต่อว่าฉันอย่างจริงจัง แต่ก็ส่งยิ้มแล้วเอี้ยวตัวเข้ามาใกล้"
...
"ฉันรู้สึกว่าวันนี้วิ่งต่ออีกรอบไม่ไหวแล้ว และพลันเปลี่ยนมาเดินแทน"
...
"เธอเบรกเอี๊ยดทันที เอมิยังหายใจได้อย่างปกติ ต่างจากฉันที่หายใจไม่ค่อยทั่วท้องด้วยซ้ำ"
...
"เอมิพยักหน้าแล้วส่งยิ้มมาให้ฉันอีกครั้ง"
...
emi "ไม่ละ ยังเหลือเวลาอีกเยอะเลย"
...
"ฉันปัด ๆ ความรู้สึกนั้นออก ซึ่งแทบไม่ได้ผลเลย"
...
ke "น่า ก็ว่าจะแบ่งให้แหละ แต่นายมีเรียนนี่ ไม่มีเวลามากินพิซซ่าหรอก"

hi "แล้วนายไม่มีเรอะ!"

ke "ฉันไม่เข้าเรียน ต้องรอพิซซ่ามาส่งแล้วจ่ายเงินแล้วก็กิน ไม่ง่ายนะเว้ย ต้องแอบไปเอาพิซซ่าแบบเงียบ ๆ ไม่งั้นเดี๋ยวมีคน\nมาเห็นแล้วมาขอแบ่งอีก"
...
"เคนจิเมินคำพูดของฉันแล้วเล่าต่อ ฉันอยากจะจับไหล่แล้วเขย่าเรียกสติสักหน่อย นี่ยังจะไหลต่ออีกเหรอ งั้นก็ได้\nถึงแม้จริง ๆ แล้วเขาน่าจะแค่ไม่ได้ยินที่ฉันพูดมากกว่า"
...
ke "ไม่แน่ฉันอาจจะรับจ๊อบไปเป็นก็ได้ แบบว่าเป็นดาราหนังโป๊ที่ต้องดิ้นรนหาเลี้ยงชีพขณะที่ต้องสู้กับแนวคิดสตรีนิยม\nแต่กะอีแค่เศษเงินหลังตู้เย็นนายก็ให้ฉันไม่ได้ ไม่มีใครเข้าใจฉันเลย ไม่มีเลย"

"ไม่ใช่ว่าพวกสตรีนิยมจะต่อต้านพวกงานลามกอนาจารแบบนั้นตั้งแต่แรกเหรอวะ"

hi "เรื่องสตรีนิยมอีกแล้วเรอะ"

ke "เรื่องนี้สำคัญนะเว้ย ฉันรู้นะว่านายไม่สนไม่แคร์ด้วยซ้ำ แต่นี่จริงจังนะ พวกสตรีนิยมน่ะ… เป็นศัตรูตัวฉกาจเลยละ\nอย่าได้ประมาทเชียว ถ้านายเผลอตัวนิดหน่อยล่ะก็ ตูม! นายได้ตื่นมาพร้อมมีดที่โผล่มาปักหลังนายแน่"
...
"ฉันเบือนหน้าหนีจากเคนจิแล้วลองทำหน้าบึ้งในกระจกเพื่อหาว่าทำหน้าแบบไหนจะตรงกับอารมณ์ตอนนี้ที่สุด\nแต่ยังไงอยู่ระยะนี้เขาคงไม่เห็นหรอก"
...
"และนั่นคือเวลาที่เสียไปและไม่มีทางได้คืนมา สักวันเดี๋ยวฉันเอาคืนเคนจิแน่"
...
"วันนี้เป็นวันที่ฉันมาถึงห้องคนแรก ถึงแม้ว่าจะเช้าไปหน่อยก็เถอะ แต่อย่างน้อยนั่งในนี้คนเดียวสักยี่สิบนาทีก็ยังดีกว่า\nต้องทนทุกข์ทรมานกับเคนจิละนะ"

"ความอ่อนล้า หงุดหงิด และเบื่อหน่ายได้หลอมรวมกันทำให้ฉันรู้สึกเพลียมาก ๆ"

"ฉับวูบหลับไปแวบนึงแล้วสะดุ้งตื่นตอนที่หัวโขกกับโต๊ะ ฉันเอามือกุมหน้าผากพร้อมเข้าใจว่าทำไมถึงควรจะนอนดึก\nและไม่ควรรีบมาเช้าจนเกินไป"

"จนในที่สุดก็ได้ยินเสียงเคาะดังมาจากข้างนอกที่โถงทางเดิน แล้วร่างสูงของลิลลี่ก็ปรากฏตรงหน้าประตูทางเข้า\nเธอไม่ได้เรียนที่ห้องนี้ เพราะงั้นคงจะมาด้วยเหตุผลอื่นมากกว่า อาจจะมาตามหาฮานาโกะ"
...
"ลิลลี่พูดเข้ามาในห้องที่เงียบสนิทด้วยน้ำเสียงอันนุ่มนวลที่รอการตอบกลับ ฉันนึกขึ้นได้ว่าความเงียบคงทำให้เธอรู้สึก\nไม่สบายใจเพราะว่าเธอตาบอด เช่นนั้นฉันจึงทำลายความเงียบลง"
...
hi "ไม่เห็นเลย ปกติเห็นจะมาช่วงก่อนระฆังเข้าคาบดังไม่นาน… หรือไม่ก็มาหลังจากนั้น อยากจะฝากฉันบอกอะไรให้\nฮานาโกะไหมล่ะ?"
...
"คำตอบของลิลลี่ที่ตอบชิซูเนะนั้นดูไว้เชิงมากกว่าตอนที่เธอตอบฉันเมื่อวันก่อน เดาว่าทั้งคู่คงจะไม่ถูกกันสักเท่าไหร่\nจริง ๆ นั่นแหละ"
...
"ตอนนี้ที่ลิลลี่รู้คือเธอกำลังคุยกับมิช่าอยู่ แต่ว่าก็รู้ว่ามิช่ากับชิซูเนะเองก็ตัวแทบติดกัน เธอน่าจะคาดว่าคนที่ “พูด” อยู่\nคือชิซูเนะ"
...
"มิช่าทำแก้มป่องด้วยความโกรธ ทำไมถึงต้องโกรธด้วยล่ะ ได้รับอารมณ์แบ่งมาจากชิซูเนะด้วยหรือไง"

"แต่ก็ไม่แปลกหรอกที่ชิซูเนะจะไม่ค่อยชอบคำชมฉัน ก็นะ ในเมื่อฉันมาถึงก่อน การฉันที่พูดว่ามาเร็วก็อาจจะทำให้\nเกิดการเข้าใจผิดได้ไปเป็นร้อยแปด"

"โดยเฉพาะกับชิซูเนะที่ไม่สามารถฟังน้ำเสียงได้"
...
mi "อยากรู้รึเปล่าว่าอะไรยากกว่าการจัดแจงงบประมาณกิจกรรมของห้องเรียนหนึ่งห้อง ก็การจัดแจงงบทุกห้องในโรงเรียนไง\nแล้ว~! คนที่ต้องจัดการเรื่องนั้นก็คือฉันไงล่ะ!"

"มิช่าทำท่าเท้าเอวแล้วยืนตัวตรง โอ้ ตอนนี้สวมบทบาทได้เหมือนเลยทีเดียว แต่ลิลลี่ก็ดูไม่ได้เล่นด้วย"
...
"ลิลลี่ดูดีใจที่ฉันเข้าข้างเธอ แต่ก็ยังรู้สึกว่าเธอไม่น่าไหวอยู่ดี"
...
hi "ชิซูเนะ ลิลลี่คงไม่ได้หยิบติดมือมาด้วยหรอก"
...
"ลิลลี่เน้นย้ำคำสุดท้ายจนน่าแปลกใจ นี่เธอรู้เรื่องที่ว่าชิซูเนะกับมิช่าพยายามพาฉันเข้าสภานักเรียนด้วยงั้นเหรอ"
...
mi "นั่นน่ะเป็นความรับผิดชอบของเธอนะ~! รายงานงบประมาณน่ะไม่ใช่อะไรที่เธอจะเอาไปให้คนอื่นมาทำแทนให้ได้นะ\nมันคือหน้าที่ของเธอในฐานะหัวหน้าห้องที่จะจัดการทุก ๆ อย่าง การที่ละเลยไม่ทำตามขั้นตอนที่ถูกต้องเนี่ยถือว่า\nใช้ไม่ได้เลยนะ~!"
...
mi "ลิลลี่ แล้วนักเรียนพวกนั้นก็พักอยู่ในโรงเรียนนี้ไม่ใช่หรือไง เดินไปห้านาทีก็ถึงแล้วนี่~"

mi "จะต้องยุ่งขนาดไหนกันนะที่ทำให้ไม่ว่างจนสละเวลาให้สักห้านาทีไม่ได้… จนต้องทิ้งภาระบางอย่างที่ทำให้คนอื่นเดือดร้อน\nทั้งห้องน่ะ"
...
"มิช่าพยายามสุดความสามารถเพื่อจะสื่ออารมณ์เดียวกันนั้น แต่ก็ดูทีท่าว่าจะไม่สามารถลดน้ำเสียงร่าเริงนั้นได้เลย\nผลที่ออกมานั้นน่าทั้งสนใจและหลอน ๆ กันทีเดียว"
...
"ในขณะที่ชิซูเนะเองนั้นทำไม้ทำมือไปตามกรอบแว่นอย่างร่าเริง เพราะรู้ว่าลิลลี่ไม่ได้ยินและไม่เห็นว่าเธอตื่นเต้นแค่ไหน"
...
"ลิลลี่กัดปากเมื่อได้ยินคำพูดของมิช่า บ่งบอกได้ว่าเธอเข้าใจถึงความหมายเบื้องหลังของคำพูดทั้งหมดที่แม้ตัวมิช่า\nที่เป็นคนพูดแทนนั้นไม่ได้เข้าใจเนื้อหาที่เสียดสีที่ซ่อนอยู่ในคำพูดนั้นเลย"
...
li "ฉันก็คุยเรื่องงบประมาณไปแล้วก่อนเธอจะมาอีกนะ คงจะเก่งมาก ๆ สินะเลยสามารถรีบจัดการงานสภานักเรียน\nของเธอจนหมดเพื่อที่จะได้มาตามจี้เพื่อให้ฉันไม่ลืมเรื่องนี้น่ะ"
...
li "แต่ก็คงเดาไม่ยากใช่มั้ยว่าเธอคือฟ้าหรือเหวน่ะนะ"
...
"บรรยากาศโดยรอบดุเดือดจากรังสีความเป็นศัตรูกันของทั้งคู่ คือจริง ๆ ตอนนี้ก็ชัดเจนมากแล้วละนะ แม้แต่มิช่าเอง\nก็เริ่มจะเข้าใจแล้วว่าอารมณ์ของบทสนทนานี้เป็นยังไง"
...
li "ใช่ เธอไม่ควรจะคาดหวังให้นักเรียนที่เพิ่งย้ายมาใหม่มาทำอะไรแบบนี้ตอนเพิ่งมาเป็นสัปดาห์แรกหรอกนะ"

"การที่ลิลลี่เข้าข้างฉันทำให้รู้สึกสบายใจขึ้นมาหน่อย ฉันเลยว่าจะช่วยเธอด้วย"
...
"ฉันไม่อยากจะมาเสียเวลากับอะไรอย่างนี้ตอนนี้ ไม่ว่าจะพูดอะไรฉันก็ต้องเผชิญหน้ากับชิซูเนะอยู่ดี ซึ่งชิซูเนะ\nก็อยากให้เป็นอย่างนั้น"
...
hi "ลิลลี่ ใกล้ได้เวลาเข้าเรียนแล้ว ค่อยมาคุยทีหลังแล้วกัน เดี๋ยวฉันบอกฮานาโกะให้ว่าเธอมาหา"

"ฉันรู้สึกได้ว่าชิซูเนะกำลังอึ้งไปอยู่ คงเป็นครั้งแรกที่มีคนเมินตรง ๆ แบบนี้"
...
"ลิลลี่ส่งยิ้มที่หวานที่สุดที่ฉันเคยเห็นในสัปดาห์นี้ให้ฉันแล้วหันหลังเดินออกไป"

hide lilly
with charaexit

"ทันทีที่ลิลลี่เดินออกจากประตูไปฉันก็เริ่มลังเลไม่อยากหันหน้าหาชิซูเนะ"

"ฉันสัมผัสได้ถึงสายตาพิฆาตของชิซูเนะที่หลังฉันและไม่กล้าหันกลับไปมองเธอ คงจะเดือดมากแน่ ๆ ฉันหวังว่ามิช่าจะพูด\nอะไรบางอย่างเพื่อลดทอนความตึงเครียดนี้ แต่เหมือนฉันจะหวังมากไป"
...
"ฉันสัมผัสได้ถึงสายตาพิฆาตของชิซูเนะที่หลังฉัน คงจะโกรธฉัน แต่ฉันเองก็โกรธเธอพอ ๆ กัน"
...
"ชิซูเนะเริ่มยิ้มอาย ๆ ฉันเลยสงสัยว่ามิช่าทำแบบนี้เพราะเธอสั่งหรือเปล่า"

"เป็นเพราะเรื่องที่เกิดระหว่างชิซูเนะกับลิลลี่ก่อนหน้านี้หรือเปล่านะ"
...
"และทั้งวันก็ผ่านไปโดยไม่มีอะไรเกิดขึ้น ซึ่งรอบนี้ฉันยินดีที่เป็นเช่นนั้น"

play sound sfx_normalbell

"พอเสียงระฆังดังฉันก็นั่งรอสักพักเพราะไม่ได้มีธุระรีบร้อนอะไรพลางทบทวนเนื้อหาที่ได้เรียนในวันนี้ ยังไงฉันเอง\nก็อยากจะออกคนท้าย ๆ อยู่แล้ว จะได้ไม่ต้องไปเบียดกับคนหมู่มากที่โถงทางเดิน"

"ฉันสังเกตเห็นชิซูเนะกับมิช่าที่ยังอยู่ด้วยคุยกับใครสักคนจากห้องอื่น"
...
"ฉันฟุบหน้าลง ไม่รู้หรอกว่าคุยอะไรกันอยู่ แต่ดูท่าว่าจะเป็นเรื่องจริงจังน่าดู และฉันคงไม่น่าจะช่วยอะไรได้ด้วย\nแล้วชิซูเนะเองก็ดูโมโหด้วย ถึงจริง ๆ ปกติท่าทางเธอก็เป็นแบบนี้อยู่แล้วละนะ"
...
"มิช่าห้อยหัวฟุบลงกับโต๊ะด้วยท่าทีหมดแรง"
...
"ท่าทางของชิซูเนะทำให้ฉันรู้สึกว่าเธอ “พูด” อย่างดูแคลน แต่มิช่าก็แปลออกมาซื่อ ๆ แล้วใส่ความสดใสร่าเริง\nของตัวเองลงไปแทนที่เจตนาจริง ๆ อะไรก็ตามของคำพูดนั้น ซึ่งก็คลาดไปจากกันอยู่ แล้วฉันคงไม่มีวันทำใจให้ชิน\nได้แน่ ๆ"

hi "ช่างเหอะ"

hi "ฉันจะลืมได้ไงว่าพวกเธอเป็นสภานักเรียน พวกเธอเล่นชวนฉันต่ำ ๆ ก็วันละสองรอบละ"
...
mi "โทษทีจ้า คุณซาโต้ไม่อยู่ที่นี่ พอดี เอ่อ มาเมื่อเช้าน่ะ"
...
mi "ถ้าเธอคนนั้นมีจิตสำนึกสักหน่อยก็คงจะอยู่ที่ห้องช่วยจัดงานเทศกาลแหละ แต่ใครจะรู้ เธอคนนั้นอาจจะจะหนี\nไปซ่อนตัวที่ไหนก็ได้"
...
mi "คงหนีไปอู้ที่ไหนสักที่แหละ เหมือนฮิจังอะนะ~! วะฮ่าฮ่า~!"
...
mi "คงหนีไปอู้ที่ไหนสักที่แหละ ช่างเป็นคนไร้ประโยชน์จริง ๆ ~!"
...
"ฮานาโกะรีบพยักหน้าแล้วถอยหนีอย่างรวดเร็ว ชัดว่าเธอไม่อยากจะเสวนากับชิซูเนะอีก ซึ่งแย่หน่อยตรงที่\nพอเป็นอย่างนั้นแล้วก็ทำให้ความสนใจของพวกชิซูเนะกลับมาที่ฉันอีกรอบ"
...
"ชิซูเนะและมิช่าต่างเคลื่อนไหวอย่างช้า ๆ อยู่ตรงหน้าฉันปิดทางหนีจนชวนให้รู้สึกเหมือนพวกเธอระแวดระวัง\nอย่างทะแม่ง ๆ เห็นแล้วก็นึกถึงเรือที่รบกันบนน้ำ"
...
mi "แต่ว่า~! นั่นแหละที่เธออยากบอก เพราะงั้น ขอร้องเถอะนะ ฉันไม่ไหวแล้ว เราต้องมาทำแผงสำหรับงานเทศกาล\nกันสองคนเนี่ย เหลือจะเชื่อเลยเนอะ"
...
"ฉันเห็นมิช่าขยับมืออย่างต่อเนื่อง"

"มิช่าแปลบทสนทนาของพวกเราเป็นภาษามือเพื่อให้ชิซูเนะเข้าใจด้วย"

"ซึ่งชิซูเนะเองวันนี้ดูเงียบแปลก ๆ ยังโกรธกันอยู่เหรอ ก็นะ คงอาจจะแหละ มองตาก็รู้ละ แต่ว่าอาจจะแค่\nทำให้ฉันรู้สึกผิดเพื่อให้ไปช่วยงานก็ได้"

"ต้องหาทางหนีทีไล่ให้ได้"

hi "เออ เดี๋ยวฉันต้องไปห้องสมุดละ แบบว่า มีการบ้าน…"

hi "ต้องรีบไปแล้วสินะ ช่วงนี้ต้องขยันหน่อยเพราะว่าฉันเพิ่งมาใหม่ จะได้มีภาพลักษณ์ที่ดีไง ใช่ ๆ …"
...
"เธอส่ายนิ้วไปมาด้วยท่าทีเยาะเย้ยพร้อมส่งภาษามือให้มิช่าราว ๆ กับนายหมู่สั่งลูกน้องทหาร"
...
mi "ช่ายแล้วชิจัง~ ดูเหมือนคงจะหนีไปอู้งานตลอดทั้งวันที่เหลือแน่ ๆ"
...
"เธอหัวเราะคิกคักตามด้วยเสียงหัวเราะระเบิดดังลั่น"
...
"พวกเธอขยับเข้ามาใกล้ราวกับว่าจะกระโจนเข้าใส่"
...
"ฉันกลับมาคิดหาทางออกจากสถานการณ์นี้อีกครั้ง ไม่ดิ การกระทำของพวกเธอมีเจตนาชัดเจนขนาดนี้ คงป่วยการ\nที่จะใช้เหตุผลเถียงด้วย"
...
"ท่าทางโกรธเคืองหายไป และมิช่าก็เริ่มหัวเราะอย่างบ้าคลั่ง แต่สงบลงตอนที่ชิซูเนะแสดงท่าทีเคือง ๆ"
...
hi "ฉันอ่านเรื่องนี้เมื่อไม่กี่เดือนก่อน เป็นเรื่องเกี่ยวกับคนกลุ่มหนึ่งที่คอยบริหารศาลเตี้ยเพื่อลงโทษผู้ชายคนหนึ่งที่แค่\nอยากจะใช้ชีวิต พวกนั้นไม่ยอมปล่อยให้เขาอยู่แบบสงบ ๆ และเขาก็ไม่สามารถต่อกรกับอำนาจได้"
...
"มิช่าหันกลับมาหาฉันหลังจากที่แปลภาษามือไปมาอยู่เสียนาน"
...
"ด้วยความภาคภูมิที่ทำงานจนแล้วเสร็จพวกเราก็นั่งชื่นชมผลงานที่ทุ่มแรงลงไปกัน ไม่ได้คุยอะไรกัน แค่ดู"
...
"พอคุ้ยกระเป๋าดูก็เจอเหรียญร้อยเยนหนึ่งเหรียญ"
...
mi "เมื่อกี้นึกว่าชิจังจะขอฮิจังคบเหรอ"
...
mi "ถ้าเธอคนนั้นมีจิตสำนึกสักหน่อยก็คงจะอยู่ห้องเธอช่วยจัดงานเทศกาลแหละ แต่ใครจะรู้ เธอคนนั้นอาจจะจะหนี\nไปซ่อนตัวที่ไหนก็ได้"
...
"บทสนทนาเริ่มขึ้นเหมือนฉันเพิ่งมาโดยไม่ได้รออยู่สิบห้านาที แต่ก็ไม่เป็นไร อย่างน้อยก็ได้คุยแล้ว"
...
"จะเป็นอย่างนั้นหรือเปล่านะ ถ้าใช่ก็แปลว่าโดดเรียนด้วย ซึ่งดูจากสภาพคนอย่างรินแล้วก็ไม่เหนือความคาดหมาย\nสักเท่าไหร่"
...
"รินพูดพลางยืดเส้นยืดสายเล็กน้อย ขาของเธอนั้นงอไปมาได้มากกว่ามนุษย์ทั่ว ๆ ไป เวลาเห็นเธอขยับตัว\nได้อย่างไม่ติดขัดอะไรเลยแล้วก็ทึ่งดี"
...
"นานด้วย เหมือนความคิดว่างไปพักหนึ่ง"
...
"จริง ๆ รินน่าจะพูดให้มันมากกว่าแค่การถามคำตอบคำนะ จะได้เหมือนการคุยกันจริง ๆ ไม่ใช่การสอบปากคำน่ะ"
...
"บางทีรินอาจจะใช้เรื่องนี้เพื่อสื่ออะไรสักอย่าง บางทีรินคงจะลืมแล้วว่าจะสื่ออะไร"
...
"ไม่ใช่ว่าไม่ชอบหรอก ถึงรินจะทำตัวงง ๆ ก็เถอะ แล้วฉันก็ไม่ได้เกลียดศิลปะขนาดนั้น บางทีฉันยังวาดรูปเล่นอยู่เลย\nเพียงแต่ฉันไม่ได้มีหัวสร้างสรรค์ขนาดนั้น ฝีมือก็ไม่มี"
...
"รินนั่งลงกับลังแล้วโยกตัวไปมาดูไม่อึดอัดอะไรกับความเงียบอันน่าอึดอัดนี้ เธอมองมาที่ฉันอีกครั้ง ไม่ก็มองที่ไหล่\nฉันมองไม่ค่อยออกว่าตาเธอจดจ่ออยู่ที่ไหนกันแน่"

"ไปดีกว่า รินจะได้ทำงานได้โดยไม่มีใครกวน ส่วนฉันก็จะไปทำอะไรอยู่คนเดียว แต่วันนี้ฉันก็ไม่ได้มีอะไรให้ทำหรอก…"
...
rin "แล้วจะมีเหตุผลอะไรอย่างอื่นอีกล่ะ อืม แต่ถ้ามีก็คงเป็นเรื่องลึกลับไปตลอดกาล พอดีฉันไม่ได้ตามเข้าไปด้วย"
...
"เข้าใจเลยแหละ ฉันรู้สึกเข้าใจรินอย่างประหลาดจนฉันยิ้มน้อย ๆ อยู่กับตัวเอง"
...
"ฮานาโกะพยักหน้าน้อย ๆ ดูระแวง บ่าเธอแข็งเป็นท่อนไม้ พอจะนึกไว้อยู่ว่าถ้าเธอไปเองคนเดียวคงสบายใจกว่า\nแต่จะให้ถอยตอนนี้ก็คงสายไป"

"เธอทำสีหน้าดูเป็นกังวลที่เธอมักทำอยู่เป็นประจำ พอมองแล้วก็พานให้ฉันระแวงไปด้วย ทำไมกันนะ"

"ฉันพอจะเข้าใจว่าทำไมฮานาโกะถึงดูหวาดระแวงอยู่ตลอดอย่างนั้น… หรือจะพูดให้ถูกก็คือพอเข้าใจว่าพอจะมี\nคนอย่างเธออยู่เหมือนกัน"
...
"ฮานาโกะพยักหน้าเล็กน้อย"

"คงจะลองไปที่โรงอาหารมาแล้วแน่ ๆ "
...
hi "อืม ก็แสดงว่ายังมีที่ให้หาอยู่สินะ เอ ถ้าให้เดาก็น่าจะอยู่ที่ห้องเรียนตัวเองอย่างที่ชิซูเนะว่าละมั้ง"
...
"เวลาจะปฏิสัมพันธ์กับฮานาโกะทีเหมือนต้องใส่ถุงมือผ้าไหมไว้สักสองชั้น"
...
"ฮานาโกะก็ดูไม่ใช่พวกที่จะโลดแล่นในกลุ่มคนสักเท่าไหร่ด้วย ลิลลี่คงจะเป็นเพื่อนคนเดียวของเธอนั่นแหละ"
...
"แต่ถ้าจริงก็แปลว่าอย่างน้อยฮานาโกะก็วางใจฉันบ้างแล้ว ซึ่งก็เป็นเรื่องที่ดี"

"สุดท้ายก็เดินมาจนถึงหน้าประตูห้อง 3-2 ฮานาโกะไม่ได้อยู่หลบหลังฉันแล้ว ฉันเปิดประตูออก"
...
"การหาตัวลิลลี่ท่ามกลางความวุ่นวายนี้ง่ายเกินคาด แต่ไม่ใช่เพราะรูปลักษณ์เธอเลย"

"มีนักเรียนอยู่สองสามคนล้อมลิลลี่อยู่หน้าห้อง เธอน่าจะเป็นคนเตรียมการอะไรทั้งหลายแหล่ หรืออย่างน้อยก็เป็นคน\nที่จัดแจงอะไรให้เข้าที่"
...
"ฮานาโกะดูออกจะลนลาน แต่เห็นคนที่อยู่เต็มห้องขนาดนี้ก็เดาสาเหตุได้ไม่ยาก"
...
"ใช่แล้ว ห้อง 3-2 เป็นห้องสำหรับคนที่มีปัญหาทางการมองเห็นโดยเฉพาะ ต้องมาเตรียมงานเทศกาลอย่างนี้คงลำบากน่าดู"

hi "ให้ช่วยอีกแรงมั้ย ถ้าอยากให้ช่วยก็ช่วยได้นะ ฮานาโกะก็น่าจะช่วยได้เหมือนกัน"

"ให้ฮานาโกะทำอะไรเบนความสนใจหน่อยน่าจะดี แต่เธอคงไม่กล้าที่จะอาสาเอง เธอพยักหน้าตกลงทันที ฉันจึงมั่นใจ\nว่าฉันทำถูกแล้วที่เสนอเธอไปด้วย"

"ลิลลี่ถอนหายใจโล่งอก"
...
"ลิลลี่ดูประหลาดใจที่ฉันรู้จักเขา แต่ก็ว่าไม่ได้น่ะนะ"
...
"เพื่อน… ไม่รู้ว่าคำนั้นจะใช้กับเคนจิได้หรือเปล่า"
...
"ถ้าทำตัวอย่างนี้กับคนในห้องก็ไม่แปลกใจเท่าไหร่ที่ต้องมาทำงานคนเดียว"
...
"เออ จริงสิ ผู้หญิง มาคิดอีกทีแล้ว ให้ฮานาโกะมาช่วยนี่ก็ไม่น่าใช่ความคิดที่ดีเท่าไหร่"
...
"และเมื่อฉันลงแปรงแล้วฮานาโกะก็เริ่มลากตามส่วนที่เป็นรายละเอียด ดูเหมือนว่าความตั้งใจฉันที่จะให้เธอ\nเบนความสนใจจากคนรอบข้างจะได้ผล"
...
"เคนจิดูจะไม่เห็นด้วยกับเจตนานั้นของฉัน"
...
"แต่ถึงงั้น ฉันอาจจะทิ้งเธอให้โดนจิกโดยไม่ได้ตั้งใจก็จริง แต่ตอนนั้นฉันก็ไม่รู้เรื่องอะไร ซึ่งก็แปลว่าฉันไม่จำเป็น\nต้องขอโทษอะไร"
...
"แต่ถึงอย่างนั้น การที่ลิลลี่ขอโทษแปลว่าต้องเป็นเรื่องใหญ่พอสมควร แม้ข้อสงสัยของฉันจะยังไม่ได้รับความกระจ่าง"
...
"ได้ฟังแล้วก็เข้าใจว่าทำไมทั้งคำพูดคำจาและกิริยามารยาทของเธอถึงได้ดีเหลือเกิน"
