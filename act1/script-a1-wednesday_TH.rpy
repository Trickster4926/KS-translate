...
"แต่ตอนนี้เรื่องนั้นไม่ใช่ปัญหา ปัญหาคือชิซูเนะกับมิช่าจะโผล่มารอคำตอบเรื่องเข้าสภานักเรียนจากฉัน ถึงจะผ่านไป\nแค่วันเดียวก็เถอะ"
...
"แต่ครูก็บอกว่าจะแบ่งกลุ่มกันอีกครั้ง"
...
mi "โธ่… ฮิจัง ยังคิดมากเรื่องเมื่อวานอยู่เหรอ ที่บอกว่าจะเก็บเรื่องเข้าสภานักเรียนไปคิดน่ะ ว่างั้นใช่มั้ย"
...
"จะว่าไปก็ไม่เคยเห็นทำงานกับใครเลย"

"แต่พอนึกได้ว่าขี้อายขนาดไหนก็ไม่แปลกใจ"
...
mi "คงงั้นนะฮิจัง สงสารที่ฮานาโกะทำงานคนเดียวเหรอ"
...
"เพราะงี้ด้วยหรือเปล่านะถึงคอยทำภาษามือตลอด ชิซูเนะจะได้มีส่วนร่วมในทุกบทสนทนา"
...
"พวกเราทำงานเสร็จด้วยเวลาที่ยังเหลือ ๆ จึงถามไปว่ามีที่ให้กินข้าวอื่นนอกจากโรงอาหารมั้ย เพราะเอาตรง ๆ\nอาหารโรงอาหารก็ไม่ค่อยอร่อย"

"ซึ่งทำให้ชิซูเนะและมิช่าเถียงกันเรื่องร้านโปรดของตัวเอง ทุกร้านที่ว่ามาอยู่ในตัวเมืองหมด ไม่น่ามีเวลาถ่อไป\nขนาดนั้นแน่ ๆ ไหนจะเงินอีก"

"เถียงเอาสนุกไปงั้นหรือเปล่าเนี่ย"

"คงงั้น เถียงไม่สนอะไรจนไม่ทันรู้ตัวว่าพักเที่ยงแล้ว"

"ฉันหันไปมองข้างหลังห้อง"

show hanako emb_downtimid at tworight
with charaenter

"เหมือนจะอ่านสมุดที่จดมาจากคาบเมื่อกี้อยู่"
...
"แต่พอมองฮานาโกะแล้วรู้สึกเหมือนมีแค่ฉันที่เห็นเธอ คล้ายว่าเธอไม่มีตัวตน แฝงตัวอยู่กลางแจ้ง"

"โดนคนในห้องแกล้งอยู่เหรอ หรือปลีกตัวออกมาเอง"
...
"ฉันเห็นฮานาโกะหันมองไปที่ประตูห้องด้านหลัง"

"จะว่าไปแล้วก็ไม่เห็นพลิกหน้ากระดาษสักหน้ามาตั้งแต่ที่มองทีแรก"
...
menu:
    ...
    "รอชิซูเนะกับมิช่าคุยกันให้เสร็จ":
        return m3
...
"ฉันทำสิ่งที่ฉันทำเมื่อไม่รู้จะทำอะไรมาตลอด"

"อย่างตอนนี้"

"ฉันอ่านหนังสือที่ยืมมาเมื่อวานเล่มหนึ่งแล้วพกมาโรงเรียนเพื่ออ่านฆ่าเวลาระหว่างรอคาบเรียน"

hide hanako
with charaexit

"ฉันเปิดหาหน้าที่พับมุมอ่านค้างไว้เมื่อคืนแล้วอ่านต่อ"

"มิช่ากับชิซูเนะยังคงทุ่มเถียงกัน คงจะเรื่องร้านอาหารนั่นแหละ"

"ถ้าคุยด้วยก็คงได้ร่วมวงเถียงอีก แย่กว่านั้นคือจะโดนเค้นเรื่องสภานักเรียน"

"มิช่าไม่ได้ออกเสียงพูดเพราะไม่จำเป็นต้องให้ใครมาฟังว่าคุยอะไรกัน"

"แต่ทำไมบางทีเวลาที่ชิซูเนะไม่จำเป็นต้องรู้ว่าใครพูดอะไรมิช่าก็ยังทำภาษามืออยู่ แล้วที่แปลกกว่านั้นคือตอนที่\nชิซูเนะไม่อยู่ก็ยังทำ ดูแล้วก็ย้อนแย้งพิลึก"

"ไม่มีสมาธิอ่านหนังสือเท่าไหร่เลย อีกอย่าง พักเที่ยงจะมามัวแต่อุดอู้อยู่กับห้องเรียนที่เนือย ๆ ไม่ได้หรอก ฉันเลยเดิน\nออกไปที่โรงอาหาร"

"ส่วนมิช่าและชิซูเนะที่ดูเหมือนจะลงตัวกันแล้วตามฉันมาทีหลัง ระหว่างทางก็คุยภาษามือกันไปด้วย"

stop music fadeout 2.0

label th_A10b:

"ยังรู้สึกผิดอยู่ที่เมื่อวานทำให้ตกใจอย่างนั้น ไปคุยอะไรด้วยหน่อยดีกว่า"
...
"โอเค อย่างน้อยก็จำชื่อได้"

hi "เอ้อ… คือจะมาขอโทษเรื่องเมื่อวาน"

hi "ไม่ได้ตั้งใจจะทำให้เธอตกใจกลัวไปแบบนั้นนะ"

hi "พอดีเพิ่งมาใหม่ ก็เลยอยากรู้จักกับคนในห้อง"

show hanako basic_bashful
with charachange

"พอเธอมองมาที่ฉันก็เห็นว่าเธอตกใจอีกแล้ว"

"ประหลาดดีที่ว่าถ้ามองจากไกล ๆ ในห้องแล้วไม่เห็น แต่พอมาดูใกล้ ๆ แล้วเห็นชัดมาก"
...
hi "แล้วรอใครอยู่เหรอ เห็นเมื่อกี้มองที่ประตู…"

show hanako basic_normal
with charachange

ha "อะ อื้ม… ลิลลี่น่ะ"

hi "อ้อ ลิลลี่ที่ตาบอดนั่นน่ะเหรอ"

"ฮานาโกะพยักหน้ารับ อดคิดไม่ได้ว่าถ้าใช้ความพิการมาระบุตัวจะเป็นเรื่องให้คนมาด่ามั้ย หรือว่าเป็นเรื่องปกติสำหรับที่นี่"

"แต่ก็คงงี้แหละมั้งเมื่อวานลิลลี่ถึงได้ตามเธอไป"

hi "ลิลลี่เธอดูเป็นคนดีนะ เพื่อนกันเหรอ"
...
"ฮานาโกะมองอีกครั้งราวหวังว่าลิลลี่จะมา"

stop music fadeout 6.0

"สงสัยทำให้อึดอัดอีกแล้ว"

hi "คือ ไม่ได้มารบกวนใช่มั้ย…"

show hanako basic_bashful
with charachange

ha "ปะ เปล่า ไม่ใช่อย่างนั้นหรอก"

ha "แค่ว่าถ้ามีลิลลี่อยู่ด้วยแล้วจะดีหน่อย…"

hi "อ๋อ อยู่ในห้องแล้วอึดอัดเหรอ"
...
"ฮานาโกะมองข้ามไหล่ฉันไปที่ชิซูเนะ"

hi "ชิซูเนะเหรอ"

"ฮานาโกะพยักหน้าอีกรอบ"

hi "ทำไมเหรอ ไม่ถูกกัน?"

"ฮานาโกะส่ายหน้า ชัดว่าไม่ใช่เรื่องที่เธออยากคุย"

"แต่ก็พอจะเข้าใจอยู่ถ้าชิซูเนะกับลิลลี่จะเข้ากันได้ไม่ดีนัก"

"การสื่อสารระหว่างสองคนนั้นเป็นไปไม่ได้ด้วยซ้ำ ขนาดว่าเห็นว่ามือใคร “พูด” อยู่แล้วมีมิช่าคอยแปลให้ยังยากเลย"

"ฮานาโกะเอาแต่มองชิซูเนะจนฉันเห็นลิลลี่ที่ประตูก่อน"
...
"ฮานาโกะหันมองตามคำพูด พอเห็นลิลลี่เธอก็พุ่งตัวไปที่ประตู"
...
li "อ๊ะ ฮานาโกะ อรุณสวัสดิ์ ประธานนักเรียนเขาอยู่ที่นี่เหรอ"
...
"ฮานาโกะเหลือบมองชิซูเนะอีกรอบราวกับจะดูว่าเธอได้ยินที่คุยกันหรือเปล่า ถึงจะเป็นไปไม่ได้ก็ตาม"

show lilly cane_sad
with charachange

li "งั้นไปกันเลยดีกว่า" 

"เสียงถอนหายใจของลิลลี่กับน้ำเสียงที่ดูร้อนรนนั้นทำฉันเลิกคิ้วขึ้น สองคนนั้นคงไม่ค่อยถูกกันมั้ง"
...
"อยากรู้แหละ แต่ก็ไม่ใช่เรื่องที่จะต้องถามหรอก ถ้าอยากให้รู้ก็คงบอกเองละนะ"

"เพิ่งมาได้สามวันก็หาเพื่อนไว้ก่อนดีกว่า ไม่ใช่ไปสอดว่าทำไมใครไม่ถูกกัน"

"แต่ก็ตลกดีที่ขนาดโรงเรียนนี้ยังมีคนที่ไม่ค่อยลงรอยกันเหมือนที่โรงเรียนเก่า"

"ต่อให้คนจะใจกว้าง แต่ยังไงก็ต้องมีไปเหยียบเท้ากันบ้างแหละ"

hi "เอ้อ ลิลลี่ สรุปเมื่อวานเป็นไงบ้าง ขอโทษที่ไม่ได้ตามไปนะ…"

show lilly cane_surprised
with charachange

li "ตายจริง ฮิซาโอะเหรอจ๊ะ ไม่ยักรู้ว่าเธออยู่ด้วย…"

"ดูเหมือนลิลลี่จะอายหน่อย ๆ ที่พูดอะไรตรง ๆ อย่างนั้นต่อหน้าฉัน"

show hanako emb_sad
with charachange

ha "ขะ ขอโทษนะลิลลี่ นึกว่าเธอรู้แล้ว…"

show lilly cane_weaksmile
with charachange

li "ไม่เป็นไรจ้ะฮานาโกะ"

li "ฮิซาโอะ เธอไม่ต้องคิดมากเรื่องเมื่อวานหรอกจ้ะ แค่เข้าใจผิดกันน่ะ"

hi "ถ้า… เธอว่างั้นฉันก็โอเค ฉันพยายามปรับตัวอยู่"

show lilly cane_smile
with charachange

li "เดี๋ยวเธอก็รู้เองว่าคนที่นี่ใจดีกว่าที่ไหน ๆ"

li "ถ้ายังมีอะไรข้องใจก็ถามได้เลยไม่ต้องเกรงใจนะจ๊ะ"
...
"ลิลลี่พยักหน้ายิ้มรับน้อย ๆ "

li "ขอโทษนะจ๊ะฮิซาโอะ พวกเราต้องไปแล้วละ"

"ฮานาโกะดูจะไม่อยากอยู่ที่นี่แล้ว ลิลลี่ก็ยังดูอายหน่อย ๆ"

"คำขอโทษของฉันมีผลอะไรบ้างไหมนะ"
...
"รู้อยู่ว่าดูเสนอหน้าไปหน่อย แต่… ลิลลี่ทำเสียงครุ่นคิดเบา ๆ พร้อมรอยยิ้ม"

show lilly cane_weaksmile
with charachange

li "พวกเราน่าจะอยู่กับเธอได้นะ ว่าไงจ๊ะ ฮานาโกะ"
...
"ฮานาโกะมองลิลลี่แล้วหันมาทางฉัน เธอตัวแข็งทื่อตาเบิกโพลง"
...
"ลิลลี่คงไม่ตกลงง่าย ๆ แน่ถ้าเห็นว่าฮานาโกะตกใจขนาดไหน แต่ก็ช่วยไม่ได้แล้วละนะ"

"จะปฏิเสธหลังจบกันแล้วก็คงงงแล้วเป็นเรื่องอีก"
...
"มิช่าและชิซูเนะยังเถียงกันเรื่องที่กินข้าวเที่ยงอยู่ ซึ่งก็ไม่เข้าใจจะเถียงทำไมเพราะถ้าจะเข้าตัวเมืองแล้วกลับมาให้ทัน\nก็ต้องไปแท็กซี่อย่างเดียว" 

hi "ยังไม่จบกันอีกเหรอ"

show misha hips_grin
with charachange

mi "อ๊ะ โทษทีฮิจัง! รอเราอยู่เหรอ"
...
hi "ก็ไม่รู้จะไปไหน เลยกะจะตามพวกเธอไปนี่แหละ"
...
"มิช่ายิ้มอย่างผู้มีชัยให้กับความไร้เป้าหมายของฉันแล้วรีบแปลคำตอบฉันให้ชิซูเนะทันที"
...
mi "ถ้ายังไม่รู้จะไปไหนงั้นไปกินข้าวเที่ยงด้วยกันกับฉันแล้วก็ชิจังมั้ย อ้อ แต่จะเข้าเมืองนะ… ไม่ต้องห่วงฮิจัง ไม่ไกลขนาดนั้น"

hi "ได้ งั้นเดี๋ยวไปด้วย"

"และพวกเราก็จากห้องเรียนมา"
...
"ทันทีที่ออกมาจากโถงทางเดินก็มีบางอย่างเข้ามาชนกับฉันอย่างจังเหมือนรถไฟเบรกแตก"
...
"เมื่อลืมตาขึ้นมาก็เห็นตากลมสีเขียวคู่หนึ่งที่มองมาทางฉัน"

show ev emi_knockeddown_largepullout
with flash

"เป็นตาของคนร้ายที่เป็นผู้หญิงตัวเตี้ยที่เข้ามาชนแล้วล้มลงไปอยู่กับพื้นทางเดิน"

"เธอที่ใส่ชุดพละขมวดคิ้ว ฉันนึกแปลกใจกับการใส่ชุดพละในเวลาพักเที่ยงแบบนี้"

"…แต่ที่เด่นกว่านั้นคือขาที่หายไป"

show ev emi_knockeddown_legs
with flash

"ไม่ใช่ว่าหายไปหรอก แค่ว่าไม่ใช่แบบเนื้อกับกระดูก ส่วนขาขาวที่เป็นเลือดเนื้อจริง ๆ มีลงมาจนถึงบริเวณหน้าแข้ง\nส่วนที่เท้าดูจะเป็นเหล็กหรือพลาสติกสักอย่างสีดำ"

"ดูไม่เป็นธรรมชาติจนรู้สึกใจคอไม่ดี เล่นเอาเกือบลืมหน้าอกที่เจ็บอยู่เลย"

show ev emi_knockeddown at center
with flash

"เธอหน้านิ่วไปเล็กน้อย ลูบ ๆ จมูกแล้วเด้งตัวขึ้นมา"
...
emi_ "โอย… นี่ นายไม่เป็นอะไรใช่มั้ย ขอโทษจริง ๆ นะ!"

emi_ "พอดีไม่ได้ดูทางแล้วนายก็โผล่ออกมาแน่ะ ขอโทษนะ… ขอโทษ!"

"สีหน้าท่าทางดูจะขอโทษจริง ๆ เหมือนลูกหมาที่เจ็บร้องหงิง ๆ"

"ความโกรธหรืออะไรหายไปฉับพลัน เพราะถ้าฉันเห็นลูกหมาเจ็บแล้วจะใจอ่อนทันที"

stop music fadeout 2.0

hi "ไม่เป็นไรหรอก ไม่ต้องเป็นห่วง… โอ๊ย…"
...
"ปากพูดงั้น แต่ในอกก็ยังเจ็บจี๊ดขึ้นมา และฉันก็รู้ว่านี่เป็นอันตรายร้ายแรงที่สุดต่อโรคของฉัน"

"อย่าหักโหม อย่าลืมกินยา และที่สำคัญที่สุด อย่าให้หน้าอกกระทบกระเทือน"
...
"ฉันลูบบริเวณหน้าอกเพื่อบรรเทาอาการเจ็บ กลั้นหายใจเพื่อจะฟังเสียงหัวใจเต้น"
...
emi_ "ให้เรียกพยาบาลมั้ย"

play music music_emi fadein 0.2

"เสียงเธอที่แหลมและดูเป็นห่วงดึงสติฉันกลับมา"

"ฉันยืนเป็นใบ้จ้องเธออยู่สองสามวินาทีจนนึกได้ว่าท่าทางฉันคงดูหนักกว่าอาการจริง ๆ แล้วยิ่งตัวเกร็งแบบนั้นอีก"

"ให้ตาย ฉันนี่คิดมากไปจริง ๆ"

hi "เอ่อ… ไม่ต้องหรอก ไม่เป็นไร"

"เมื่อตั้งสติตอบกลับได้ก็ยืดตัวตรงพร้อมความปวดที่ซี่โครงหน่อย ๆ แล้วสูดหายใจลึก ๆ"

"คงจะชนแล้วจุกอกขึ้นมา แต่ก็แค่นั้นแหละ"

show emi basic_hes_gym
with charachange

emi_ "ไม่เป็นไรจริง ๆ นะ เมื่อกี้ชนซะแรงเลย"

hi "สบายมาก ก็บอกแล้วว่าไม่เป็นไรหรอก ไม่มีอะไรเสีย ไม่มีอะไรพัง"

show emi basic_happy_gym
with charachange

emi_ "งั้นก็ดีแล้วละ! พอดีฉัน—"

#*****************************

label th_A11b:

"มีมือหนึ่งตบลงมาที่บ่าของฉัน ตาของหญิงสาวตรงหน้าเบิกด้วยความสยอง ประโยคที่เธอพูดมาถูกคั่นกลางด้วย—{w=.9}{nw}"
...
"ฉันไม่ทันได้หันหลังไปมองเพราะถูกชิซูเนะผลักออกมาก่อน เธอย่างสามขุมเข้าไปหาหญิงสาวและทำภาษามือ\nด้วยความโกรธเกรี้ยว"
...
emi_ "เอ่อ ขอโทษที พอดีมีธุระรีบไปเอาของน่ะ"
...
"เธอหน้าแดงแล้วทำตัวบิดไปมาเหมือนเด็กที่โดนจับได้ว่าทำผิด"

"น่ารักจนอดยิ้มไม่ได้"

emi_ "รู้น่า! ฉะ ฉันแค่…"
...
mi "อย่าทำอีกแล้วกันค่ะ… แต่รู้อยู่ว่าบอกไปก็คงไม่ดีขึ้นหรอก แล้วฉันก็จะต้องปวดหัวอีกถ้าคุณทำผิดกฎซ้ำ"
...
emi "ครูเล่นฉันตายแน่! ฉันบอกว่าจะไปช่วยเรื่องเอกสารแต่กลับไปวิ่งแทน! ขอโทษทีนะ ต้องรีบไปเปลี่ยนชุดไปอะไรก่อนแล้ว!"
...
"มิช่าและชิซูเนะยังไม่ทันได้พูดอะไรเธอก็พุ่งตัวออกไปจากจุดที่อยู่เมื่อกี้จนเกือบถึงบันได"
...
"ชิซูเนะดูเหมือนพร้อมจะสั่งระเบิดลงได้ทุกเมื่อ ฉันจึงยิ้มแห้ง ๆ หวังให้เธอใจเย็น"
...
mi "ไหวมั้ยฮิจัง อิบาราซากิเขาก็ทำคนอื่นเดือดร้อนอย่างนั้นตลอดแหละ"

hi "เอ่อ คือ ฉันว่าชิซูเนะไม่น่าเรียกฉันว่า “ฮิจัง” นะ"
...
hi "เอ้อ นั่นแหละ ฉันไม่เป็นไร แค่จุกนิดหน่อย"
...
"ไม่น่าเรียกว่าดีได้นะ แต่ก็ปล่อย ๆ ไปหน่อยแล้วกัน"
...
mi "งั้นก็รีบไปกันเถอะฮิจัง~! ไปกินข้าวเที่ยง!"

show misha hips_grin
with charachange

mi "รับประกันเลยว่าสุดยอด!"

hi "จะเชื่อเธอแล้วกัน เป็นร้านแบบไหนเหรอ"

hi "ร้านอาหารหรืออะไร"
...
mi "ไหงมองกระเป๋าสตางค์ตัวเองแบบนั้นล่ะฮิจัง ไม่เป็นไรน่า ถ้าไม่มีเงินเดี๋ยวเลี้ยง~!"

hi "ขอบคุณที่อุตส่าห์เลี้ยงนะ"

show misha hips_smile
with charachange

mi "ไม่เป็นไรน่าฮิจัง! ก็พวกเราเป็นเพื่อนกันนี่นา เนอะ ฮิจัง"

"เพิ่งมาได้สามวันเอง เป็นเพื่อนกันเร็วขนาดนี้เลยเหรอ"

"ฮะ ๆ แต่ได้ยินแล้วก็มีความสุขดี"
...
mi "อ้อ แต่ก็แค่วันนี้ แล้วก็ต้องตกลงตอนนี้ด้วยนะ! ฮิจังจะไปมั้ย"

"รู้สึกเหมือนเป็นกับดักเลยแฮะ อันนี้คือคำชวนของมิช่าหรือชิซูเนะกันแน่ ตรงนี้สำคัญเพราะฉันยังระแวงกับเจตนาแฝงของ\nผู้หญิงที่ชอบเล่นเกมครองโลกเป็นงานอดิเรก"

"ไม่หรอก คิดมากน่า ที่จริงก็เริ่มชอบอยู่กับพวกเธอขึ้นมาแล้วด้วย แล้วเดี๋ยวยังไงก็ต้องเข้าเมืองอยู่ดี\nไปตอนนี้กับพวกเธอเลยก็ได้"

"ฉันไม่เคยเข้าโรงน้ำชามาก่อน ภาพในหัวก็เป็นตามที่เห็นจากทีวี แต่พวกนั้นก็เป็นละครย้อนยุค แต่ตอนนี้ไม่น่าใช่แล้ว\nอาจจะเป็นแค่คาเฟปกติแล้วเรียกโรงน้ำชาเฉย ๆ"

"แต่ยังไงก็อยากรู้อยู่ดี เพราะงั้นไปด้วยดีกว่า"
...
mi "เยี่ยมเลยฮิจัง เยี่ยมจริง ๆ เยี่ยมจริง ๆ ! เย้~!"

"มิช่าดีอกดีใจเต้นไปมาน้อย ๆ จนทำคนเริ่มมอง ส่วนชิซูเนะเลือกที่จะปรบมืออย่างสุภาพอยู่สักสองวินาทีก่อนจะกลับเข้าสู่\nอารมณ์นิ่ง ๆ อย่างเดิม"

show shizu behind_blank
with charachange

hi "ดีใจสักหน่อยมันจะตายหรือยังไงชิซูเนะ"
...
mi "โฮ่ ไม่ยักรู้ว่าฮิจังเป็นราชานะเนี่ย ฮ่าฮ่าฮ่าฮ่า~!"

show shizu adjust_smug
with charachange

"ชิซูเนะดันแว่นระหว่างที่มิช่าแปลข้อความมาโดยไร้ซึ่งน้ำเสียงประชด ถ้าเกิดว่าพูดน้ำเสียงอย่างที่ชิซูเนะตั้งใจจะทำ\nก็คงเจ็บกว่านี้แหละ ดีเหมือนกันที่มีมิช่าเป็นกำแพงคั่นกลางให้"

hi "ไม่ได้จะบอกให้กระโดดโลดเต้นเพราะฉันยอมกินข้าวเที่ยงด้วยสักหน่อย ฉันไม่ได้ถือตัวขนาดนั้น"
...
"เธอดูจะยอมรับ แล้วเราก็เข้าเมืองไปโดยมีชิซูเนะนำทาง"
...
mi "พวกเราต้องไปแล้วละ มีประชุมสำคัญของสภานักเรียนเรื่องงานเทศกาล แล้วก็ตกลงกันได้แล้วว่าจะไปกินข้าวที่ไหนดี~!"
...
mi "น่าเสียดายที่นายมาด้วยไม่ได้ เพราะประชุมมื้อเที่ยงมีไว้สำหรับสมาชิกสภานักเรียนเท่านั้น"

show misha hips_grin
with charachange

mi "ไว้เดี๋ยวพาไป! เอ้อ แต่เดี๋ยวก็เหมือนเป็นเดตสิเนอะ"
...
"สองสาวเดินลงไปชั้นล่าง"

"ยังไม่ทันได้เดินไปไหนไกลจากโถงทางเดินชั้นสามนี้แล้วก็ปะทะเข้ากับเรื่องเลย ฉันเองก็ไปบ้างดีกว่า"

scene bg school_scienceroom
with shorttimeskip

"ทั้งพักเที่ยงและคาบบ่ายผ่านไปโดยไม่มีอะไรเกิดขึ้น"

"ฉันอ่านหนังสือที่เริ่มอ่านมาจากเมื่อวาน กินอาหารรสชาติเหลือรับประทานที่โรงอาหาร"

"และเข้าคาบเรียนแสนน่าเบื่อ"
...
"แล้วพวกเราก็มาด้วยกันสามคน"

show hanako emb_downtimid at center
show lilly cane_smile at twoleft
with charaenter

"ลิลลี่เดินไปตามกำแพงจับไม้เท้าแตะตามทางเป็นระยะ ๆ ส่วนฮานาโกะก็เดินขนาบมาใกล้ ๆ จนแขนข้างหนึ่งโอบลิลลี่\nไปแล้ว"

"ทั้งที่ลิลลี่น่าจะเดินลำบากขึ้นมาก แต่เธอก็ยังเดินไปอย่างใจเย็น"

show hanako defarms_shock
with charachange

"ทันทีที่พวกเราออกมาจากโถงทางเดินก็มีบางอย่างเข้ามาชนกับฉันอย่างจังเหมือนรถจักรไอน้ำ ฮานาโกะกรีดร้อง\nออกมาเบา ๆ และฉันก็วูบไปแวบหนึ่ง"
...
li "ฮิซาโอะ เกิดอะไรขึ้น"

"แน่นอนว่าเธอไม่ได้ตามมาในทันทีที่เกิดเรื่อง แต่น้ำเสียงดูเป็นห่วงมาก มากกว่าเรื่องที่เกิดด้วยซ้ำไป"

hi "แค่คนมาชนน่ะ ไม่มีอะไรหรอก จุกนิดหน่อย"

show emi excited_sad_gym
with charachange

emi_ "เอ่อ ขอโทษที ฉันผิดเอง พอดีมีธุระรีบไปเอาของน่ะ"

show lilly cane_weaksmile
show hanako def_worry
with charachange

li "“คน” ที่ว่านั่นคือเอมิใช่มั้ย"

show emi basic_hes_gym 
with charachange

"เธอกระแอมเบา ๆ แล้วจัดแจงขาของเธอที่ดูจะเป็นพลาสติกไม่ก็เหล็ก เธอก้มมองก่อนจะพูดอะไรต่อ"

show emi basic_closedgrin_gym 
with charachange

emi "ไง ลิลลี่ ฮานาโกะ"
...
li "เธอต้องระวังให้มากกว่านี้นะ เธออาจจะแข็งแรงพอที่จะไม่เป็นอะไรเวลาเกิดอุบัติเหตุแบบนี้ แต่คนที่แข็งแรงไม่พอก็มี"
...
"ก่อนที่เราสามคนจะทันได้พูดอะไร เอมิก็พุ่งตัวออกไปก่อนแล้ว ทิ้งไว้เพียงโถงทางเดินให้วังเวง"
...
li "ที่ยามากุเขามีกฎเรื่องห้ามวิ่งในโถงทางเดินอะไรเป็นพิเศษนะจ๊ะ"

show lilly cane_listen
with charachange

li "…แต่ดูเหมือนว่าเอมิเขาจะไม่ค่อยฟังเลย"

show lilly cane_weaksmile
with charachange

"เธอส่ายหน้าเบา ๆ แล้วระบายยิ้มสงบจาง ๆ"

li "ฉันว่าจะทำอะไรไปก็คงหยุดเธอไม่ได้หรอก งั้นพวกเราไปกันเลยมั้ยจ๊ะ"
...
"ลิลลี่เดินนำไปตามโถงทางเดิน ส่วนฮานาโกะก็รีบตามไป"

"ทางไปห้องที่ทั้งสองคนใช้ดื่มชานั้นไม่ซับซ้อนมาก ความทรงจำจากเมื่อวานยังไม่ไปไหน"
...
"พอเห็นชิซูเนะเดินนำอยู่ก็สังเกตว่าเธอเดินเร็ว ก้าวท้าวยาว ดูหนักแน่น"

"ถ้าเดินฝ่าพายุหิมะแล้วเดินแบบนี้ก็ว่าไปอย่าง แต่วันนี้ท้องฟ้าก็แจ่มใสดี นั่นแหละ แค่เห็นก็เหนื่อยแทนแล้ว "

scene bg suburb_shanghaiext
with locationchange

"พวกเรามาถึงที่โรงน้ำชาด้วยเวลาที่มิช่าบอกว่า “เวลาที่น้อยที่สุดเป็นประวัติการณ์” ที่น่าจะเป็นเพราะชิซูเนะที่เดินมาเร็ว\nแอบผิดหวังนิดหน่อยที่ร้านไม่ใช่ตึกยุคโบราณที่ใช้เสื่อปูพื้นแล้วมีผู้หญิงใส่ชุดกิโมโนคอยรินชาให้"

"เป็นคาเฟอย่างที่คิดไว้มากกว่า ก็ไม่ได้แย่หรอก ดูดีด้วยซ้ำ"
...
"ทันทีที่เดินผ่านประตูเข้าร้านก็มีคนพุ่งเข้ามาทันทีราวกับซุ่มรออยู่ก่อนแล้ว"

show yuukoshang closedhappy_down at center
with charaenter

yu "ยินดีต้อนรับค่ะ! ขอบคุณที่แวะมานะคะ!"

"เธอโค้งตัวเก้าสิบองศาเหมือนขวานที่ผ่าไม้"

"นึกแปลกใจที่เธอคือบรรณารักษ์ยูโกะนี่เอง"

hi "โห ไม่ยักรู้ว่าคุณทำงานที่นี่นะครับเนี่ย"

show yuukoshang smile_down
with charachange

yu "อ้อ… ใช่แล้วละ เป็นพนักงานเสิร์ฟน่ะ… ทำงานมาได้หนึ่งปีหกเดือนสองสัปดาห์แล้ว… ขอบคุณที่เลือกร้านเรานะคะ\nจะรับอะไรดีคะ"
...
hi "มิช่า เธอสองคนรู้จักยูโกะด้วยเหรอ"

show misha perky_smile
with charachange

mi "ก็ยูจังทำงานที่ห้องสมุดนี่นา~! ฉันเองไม่ได้ไปบ่อยเท่าไหร่หรอก แต่ชิจังรู้จักนะ! แล้วก็~! เราสองคนมาที่นี่บ่อยด้วย\nเหมือนได้เจอกันตลอดเลย!"

show yuukoshang neurotic_up
with charachange

yu "เอ่อ… ใช่แล้ว… เหมือนเดิมมั้ย แล้วก็… ถ้าอยากรับอะไรเพิ่มก็สั่งได้ตลอดเลยนะคะ"

hi "ไม่ต้องทางการขนาดนั้นหรอกครับ คนกันเองทั้งนั้น"

"แถมวันนี้ไม่ค่อยมีคนด้วย จะปล่อยสบาย ๆ ก็ได้"

"ฉันพูดด้วยหวังว่าเธอจะได้ไม่ต้องเกร็ง แต่กลับได้ผลตรงข้าม"

show yuukoshang panic_up
with charachange

yu "ไม่ได้สิ… นี่คือหน้าที่ฉันในฐานะพนักงานเสิร์ฟนะ ต้อง… ทำให้ดี"
...
mi "โอเค ๆ ~! ชิจังว่าตามนั้น! ยูจัง ขอเหมือนเดิมสำหรับชิจัง ส่วนฉันขอชาเขียวนมน้ำผึ้งแล้วกัน"

hi "ไม่ต้องเครียดหรอกครับ"

show yuukoshang neurotic_up
with charachange

yu "เอ่อ ได้… แต่ว่า… นี่มันงานฉันนะ แล้วก็… เครียดตลอดเลย ขอโทษที่เถียงกับคุณลูกค้าค่ะ… ขอโทษค่ะ! ขอโทษ ๆ !"

"ยูโกะโค้งด้วยความเร็วร้อยหกสิบกิโลเมตรต่อชั่วโมงอีกครั้ง ฉันยอมปล่อยแล้วไปนั่งกับชิซูเนะกับมิช่าที่โต๊ะ"

scene bg suburb_shanghaiint at bgleft
with shorttimeskip

"ทันทีที่นั่งลงยูโกะก็มาด้วยสีหน้าที่ร้อนรนกว่าเก่า"

show yuukoshang panic_up
with charachange

yu "ขอโทษค่ะ! ขอโทษ ขอโทษจริง ๆ ที่ลืมรับออเดอร์ไว้… ฉัน… ไม่เอาใจใส่ลูกค้า เป็นความผิดพลาด… ขอโทษค่ะ… ถ้ามีอะไร\nที่พอจะชดใช้ให้ได้ก็บอกเลยนะคะ…"
...
mi "ไม่เป็นไรน่ายูจัง ฮิจังก็ไม่ได้สั่งอะไร เธอไม่ได้ผิดหรอก ไม่ต้องเครียด ๆ"

"ก็จริง คงต้องสั่งแล้วแหละ แต่ไม่รู้ที่นี่มีอะไรขายบ้าง เหมือนจะไม่มีใบเมนูด้วย"

hi "นั่นแหละครับ งั้นผมขอกาแฟ แล้วก็… แซนด์วิช ถ้ามีนะครับ ขอแบบไหนก็ได้ที่คุณคิดว่าอร่อยที่สุดของร้าน\nพอดีชิซูเนะเขาออกเงินให้น่ะครับ"

scene ev shizu_shanghai_borednormal
with dissolve

"ชิซูเนะขมวดคิ้วมองมาด้วยสายตาที่ทั้งอึ้ง ทึ่ง งง ระคนโกรธ ไม่แน่ใจว่าจะรู้สึกยังไง"
...
mi "ฮิจังมีเงินติดตัวมาเท่าไหร่น่ะ คงไม่ได้น้อยขนาดนั้นใช่มั้ย ใช่มั้ย หารสามกันแฟร์ ๆ ดีกว่า~! อื้ม ไม่รับความเห็นต่าง~!"
...
mi "ยูจัง ชิจังบอกว่าขออะไรก็ได้ที่แพงที่สุดมาสามที่~"
...
mi "ฮ่าฮ่าฮ่า~! หยอก ๆ น่าฮิจัง…"

scene bg suburb_shanghaiint
show yuukoshang neurotic_up at center
with dissolve

yu "เอ่อ… ได้ ร้านนี้แซนด์วิชไก่น่าจะอร่อยสุดแล้ว… มีซุปแถมให้ด้วย… แต่ว่าพนักงานที่ดีต้องแนะนำเมนูที่มีเยอะที่สุด…\nไม่ก็เมนูที่แพงที่สุด…"

show yuukoshang worried_up
with dissolve

yu "ฉันทำหน้าที่บกพร่องหรือเปล่านะ"

hi "ไม่เลย ๆ ! ผมได้ครับ ขอตามนั้น แล้วก็กาแฟ"
...
"ไม่กี่นาทียูโกะก็กลับมาพร้อมเครื่องดื่มที่สั่งไปพร้อมแซนด์วิช ชิซูเนะดูจะพอใจแล้วกับชา ส่วนมิช่าสั่งพาร์เฟต์อีก\nไม่รู้ว่าจะสั่งทำไม เพราะนึกแทบไม่ออกเลยว่าจะมีอะไรที่กินกับชาแล้วไม่เข้าคู่กันไปกว่านี้อีก"

"แต่เอาเหอะ ฉันกินแซนด์วิชก่อน ซึ่งอร่อยมาก"
...
mi "ฮิจัง ไปคิดเรื่องเข้าสภานักเรียนมาหรือยัง"
...
mi "กินอยู่ก็อย่าเพิ่งพูดสิ…"

scene bg suburb_shanghaiint at bgleft
with dissolve

"ฉันจิบกาแฟตาม ซึ่งก็อร่อยเหลือเชื่อเหมือนกัน แต่ตอนนี้ไม่ใช่เวลามาเห่ชมเครื่องคาวหวานของร้านนี้"

hi "เธอพูดเองไม่ใช่เหรอว่ารู้ว่าถ้าคาดหวังคำตอบตอนนี้ยังเร็วไปน่ะ! เพิ่งบอกไปสามชั่วโมงที่แล้วมั้ง!"
...
mi "นายต้องมาเข้าสภานักเรียนให้ได้เลยนะฮิจัง เถอะน่า สนุกแน่!"

hi "ไอ้วลี “เถอะน่า สนุกแน่” เนี่ย มันไม่เคยจะสนุกเล้ย"
...
mi "ไม่เชื่อเหรอฮิจัง"

"อันนี้ชิซูเนะหรือมิช่าพูดนะ ก็น่ารักดีอยู่หรอก แต่ดูแล้วขนลุกแปลก ๆ เหมือนมีสองบุคลิกยังไงยังงั้น"
...
mi "ฮิจัง เสียใจนะเนี่ย พวกเราแค่อยากอยู่กับนาย…"
...
mi "ช่าย ทุกคนได้ผลประโยชน์ ทุกอย่างลงตัวเป๊ะ~"
...
mi "อื้ม ก็นึกว่าฮิจังจะยินดีด้วยเสียอีก… เศร้าจัง"

"อยู่ ๆ ก็รู้สึกเหมือนอยู่นอกวง"

hi "พูดถึงเขาแล้วไม่ให้เขาคุยด้วยมันไม่ดีนะ"

show shizu adjust_happy_close
with charachange

"ชิซูเนะดันแว่นแล้วหัวเราะกับตัวเอง"

shi "…"

mi "โธ่ แต่นี่พูดจริงนะฮิจัง~! นายจะได้มาช่วยพวกเราด้วย ปีนี้คนเข้ายิ่งน้อย ๆ อยู่"
...
mi "อ๊ะ ความลับนะฮิจัง"

hi "ไม่ ที่อยากรู้คือน้อยแค่ไหน “น้อย” ที่ว่านี่กี่คน"
...
mi "วะฮ่าฮ่า~! ฮิจัง ไม่สำคัญหรอก ที่สำคัญคือว่าจำนวนมันน้อยแล้วอยากให้นายมาช่วย แถมใกล้ถึงวันจัดงานเทศกาลอีก\nแถมงานสภานักเรียนปีนี้ก็ดูจะวุ่นวายด้วยสิ"

hi "นี่คือจะไม่ตอบคำถามกันแล้ว?"
...
"ฉันถอนหายใจแล้วยืดตัวนั่งหลังตรงทำท่าให้ดูต่อต้านที่สุด เพราะเหมือนว่าเรื่องนี้จะเป็นปัญหาใหญ่ แล้วฉันก็ไม่อยาก\nปล่อยไปง่าย ๆ ด้วย ตลกตัวเองเหมือนกัน ทำเป็นปลาปักเป้าไปได้"

hi "ก็ได้ งั้นอย่างน้อยก็บอกมา ว่าสมาชิกสภานักเรียนมีกี่คนถ้วน"
...
mi "อ่า เอ่อ ฮิจัง คือคนน้อยแหละ แต่ก็พอจะให้สภานักเรียนยังไปต่อได้ ใช่ ๆ ~!"

hi "คงไม่ใช่ว่ามีแค่เธอสองคนหรอกนะ"

show misha cross_laugh_close
with charachange

mi "ฮ่าฮ่าฮ่า~! ฮิจังนี่ตลกจัง~!"
...
mi "แต่~! ไม่ได้มีแค่พวกเราแน่ ๆ"

hi "แน่ใจนะ แน่ใจจริง ๆ นะ"
...
"ฉันจ้องมองทั้งสองคนดูว่าจะมีใครหลุดแล้วเป็นตามที่กลัวจริง ๆ มั้ย"

show misha perky_sad_close
with charachange

"มิช่าขมวดคิ้วดูอึดอัด แต่ก็คงเพราะฉันจ้องนั่นแหละ"

show shizu basic_happy_close
with charachange

"แต่ชิซูเนะกลับจ้องตากลับ คงจะท้าทายอยู่มั้ง มองลอดแว่นมาด้วย ทั้งเย้าหยอกและดูเป็นเด็กอย่างเหลือเชื่อ\nเหมือนสาวน้อยที่ชวนให้มาเล่นด้วยกัน"
...
mi "ฮิจัง ตัวแทนสภานักเรียนสุดน่ารักสองคนคอยต้อนรับนายแถมยังเลี้ยงข้าวเที่ยงอีกขนาดนี้ นายต้องตอบแทนด้วยการ\nเข้าสภานักเรียนมาช่วยสิ"

mi "อื้ม ถ้านายมาช่วยเราจัดการเอกสารสักหน่อยก็คงดี แถม… งานเทศกาลก็ใกล้เข้ามาแล้วด้วย ต้องทำพวกแผงเกม\nแผงขายอาหารสักสองสามแผง ถ้ามาช่วยก็จะเบาภาระไปได้เยอะเลย…"
...
"เป็นการเล่นตำรวจดี–ตำรวจเลวที่น่าสนใจดีจริง ๆ"

"ลองสักหน่อยก็คงไม่เสียหาย"

"แค่สักหน่อย"

hi "โอเค จะทดลองเป็นดูก่อน แต่ไม่ได้หมายความว่าจะเข้าร่วมอะไรแบบถาวรนะ แค่จะไปช่วยนิดหน่อยดูก่อน\nเรื่องข้าวเที่ยงนี่ก็จะได้เจ๊ากันไป ไม่ได้ทำเพราะอยากทำนะ"

show misha perky_smile_close
show shizu basic_frown_close
with charachange

"ฉันกินแซนด์วิชคำสุดท้าย และพอมิช่าเห็นเธอก็นึกได้ว่ายังมีพาร์เฟต์ให้กินอีกจึงเริ่มกิน ซึ่งชิซูเนะดูจะไม่พอใจนัก\nสังเกตจากนิ้วที่ยังขยับไปมาเหมือนอยากจะบอกอะไรอีกหลายอย่าง"
...
"ทุกครั้งที่มองชิซูเนะเธอจะมองกลับมาด้วยสายตาจดจ่อเสมอ ครั้งนี้ก็เช่นกัน สีหน้าเธอยังดูนิ่ง คงคิดอะไรอยู่ จนสุดท้ายก็\nเปลี่ยนเป็นรอยยิ้ม"
...
"เธอทำภาษามือบางอย่าง ซึ่งเธอต้องเข้าใจว่าฉันอ่านไม่ออก แล้วก็ทำอีก ความขี้เล่นอย่างเด็ก ๆ ส่งผ่านมาด้วยความเร็ว\nและความแรงจากท่าทางของเธอ"
...
"มิช่าเงยหน้าขึ้นมาจากพาร์เฟต์ เลือกไม่ถูกว่าจะช่วยหรือกินต่อดี"

hi "อันนี้แปลว่าอะไร"

"ฉันลอกท่าขยับมือให้เหมือนชิซูเนะอย่างสุดความสามารถ และรู้สึกทันทีว่าไม่ง่ายเลย แล้วลองนึกสภาพถ้าต้องสื่อสาร\nด้วยแค่สิ่งนี้ทั้งวัน"

show misha perky_smile_close
with charachange

mi "อืมมม~… โทษทีนะฮิจัง บอกไม่ได้หรอก"

hi "ไหงงั้น เป็นคำด่าเหรอ"

show misha hips_grin_close
with charachange

mi "ไม่หรอกฮิจัง ที่บอกไม่ได้ก็เพราะ~! ความหมายมันดี"

"ความหมายดีเหรอ แต่ทั้งคู่ก็หันไปสนใจกับชากับของกินของตัวเองกันต่อ คงคุยอะไรอีกไม่ได้แล้วละ"

hide misha
hide shizu
with charaexit

"ฉันไม่รู้จริง ๆ แต่ก็อยากรู้เหมือนกัน หรือจะลองเรียนภาษามือดี ที่โรงเรียนน่าจะมีสอน"

"จะเอาจริงเหรอ ฉันคิดไปพลางดื่มกาแฟจนหมด คิดอยู่ว่าทำไมถึงเก็บมาคิด"

"อยู่เพลินเสียจนลืมเลยว่าต้องกลับไปเรียนเมื่อสิบนาทีที่แล้ว"

"ต่อให้กลับไปตอนนี้ก็คงใช้เวลาอย่างน้อย ๆ อีก… สามสิบนาทีมั้ง ยิ่งมีโรคแบบนี้จะวิ่งไม่ได้เด็ดขาด\nคงใช้เวลาประมาณนั้นแหละ"

"แต่ยังไงก็สายมาตั้งสิบนาทีแล้ว ต่อให้หายตัวไปโผล่ที่ห้องเลยได้ก็คงไม่ต่างกันเท่าไหร่"
...
hi "เพิ่งนึกได้ว่าหมดพักเที่ยงไปตั้งกะสิบนาทีที่แล้วน่ะ เพิ่งมาได้สามวันก็จะเข้าห้องสายซะแล้ว"
...
hi "เฮ้ย ไม่ตลกนะ พวกเธอก็ด้วย! เป็นสมาชิกสภานักเรียนกันไม่ใช่เหรอ เดี๋ยวก็เป็นตัวอย่างที่ไม่ดีหรอก"

show misha perky_sad_close
with charachange

mi "ฮิจังมีคุณธรรมดีจัง…"
...
mi "แต่~! ฮิจังพูดถูก เขาจะเข้าห้องสาย แล้ว~ นายก็จะสายจริง ๆ เพราะไม่พยายามไปให้ทันด้วย"

mi "ในฐานะตัวแทนของสภานักเรียน พวกเราจะจัดการให้นายถูกลงโทษให้ได้~!"

hi "แต่พวกเธอสองคนเป็นคนลากฉันมาที่นี่นะ ความผิดพวกเธอก็รับผิดชอบด้วยสิ"
...
mi "ฮิจัง พวกเราแค่พาว่าที่สมาชิกสภานักเรียนมาคุยให้เข้าร่วมด้วยนะ เป็นงานไง ๆ ~! แต่~! นายไม่ใช่สภานักเรียน\nเพราะฉะนั้นนายไม่มีข้ออ้าง!"

hi "มีสิ ก็ว่าที่สมาชิกสภานักเรียนที่ว่าก็คือฉันนี่ไง"
...
mi "ใช่แล้ว~! นายจะเข้าสภานักเรียนมั้ยล่ะฮิจัง"

"ชิซูเนะวางท่ายกถ้วยน้ำชาพลางยักนิ้วก้อยชี้ไปมา"
...
mi "ฮิจัง ถ้านายเป็นสมาชิกสภานักเรียนละก็นะ… แต่ว่า~! นายจะเข้าตอนนี้ก็ได้นะ ฮิจัง! ถ้านายเข้าตอนนี้ นายจะไม่โดน\nอะไรเลย แถมจะได้ออกมาเที่ยวแบบนี้บ่อย ๆ ด้วย! บอกเลยว่าสนุก~!"

"เริ่มคิดแล้วว่าหรือบางทีทั้งหมดนี่เป็นแผนที่วางเอาไว้หมดแล้วหรือเปล่า ประมาณว่าชิซูเนะล่อให้มาที่นี่แล้วกะว่าฉันจะลืมเวลา\nจนเรื่องจะเป็นแบบนี้"

"ร้ายกาจ …แต่เท่าที่รู้จักเธอ จริง ๆ ก็น่าจะระวังตัวให้มากกว่านี้ แต่ฉันคงไม่ยอมรับแน่ ๆ ละว่าฉันหลงกลจนติดกับ"

"ฉันเพ่งอ่านเจตนาของชิซูเนะจากดวงตาของเธอ ทว่าเธอเพียงมองกลับมาเฉย ๆ ด้วยตาใสซื่อพลางจิบชาเหมือนเยาะเย้ย"
...
mi "เอ้อ ฮิจัง ฉันไม่ได้วางแผนมาก่อนเลยนะ แค่บังเอิญว่ามันลงล็อกมาเป็นแบบนี้น่ะ~!"

"ทีแรกก็อยากจะปัดเรื่องแผนว่าคิดมากไปเองอยู่หรอก แต่พูดงี้แล้วก็ทำเอาเริ่มมาคิดใหม่ เกือบหงายหลังล้มตึง\nด้วยความอึ้ง สรุปก็เป็นหมากที่วางมาแล้วเพื่อจะมัดมือชกให้ฉันเข้าร่วมสภานักเรียนจริง ๆ"
...
mi "อะฮ่าฮ่าฮ่าฮ่า~! นายดูหงุดหงิดจังฮิจัง~! คิดจริง ๆ เหรอเนี่ยว่าพวกเราหลอกนายมาตลอด"

hi "แล้วไม่ได้หลอกเหรอ"
...
"มิช่าขมวดคิ้วดูใจสลาย ชิซูเนะก็ขมวดคิ้วตาม เข้าขากันดีจริง ๆ เป็นคู่ที่สมกันเหลือเกิน แฝดกันแหง ๆ"

shi "…"

mi "ชิจังบอกว่าเธอปลื้มละฮิจัง แต่การทำอย่างนั้นจะเป็นการใช้อำนาจในทางที่ผิดมหันต์ และเป็นการลิดรอนสิทธิเสรีภาพ\nของนายด้วย~! แถม~! ยังเป็นการแบล็กเมลด้วย! ชิจังไม่มีวันทำอย่างนั้น แน่นอน!"

"ในใจนึกอยากถามมิช่าว่า “แน่ใจนะ” แต่ก็ยั้งปากไว้ทัน"
...
mi "แต่นั่นแหละฮิจัง ที่ชิจังพูดน่ะจริงนะ ไหน ๆ นายก็อยู่กับพวกเราแล้ว แถมมาทำงานสภานักเรียนด้วย\nจะโดดสักคาบสองคาบก็ไม่เป็นไรหรอก"
...
mi "แต่ใช่ว่าจะเป็นข้ออ้างที่ดีนะ…"
...
mi "…ห้ามใช้เกินเดือนละสามครั้งด้วย…"
...
mi "เพราะงั้น~! เรา{b}ต้อง{/b}กลับเข้าห้อง! อยู่ดี~!"
...
"ชิซูเนะโบกมือเรียกยูโกะแล้วชี้ไปที่ถ้วยน้ำชาที่ว่างเปล่าเพื่อให้เธอมาเติม ในขณะที่มิช่าก็รีบกินพาร์เฟต์ให้หมดเพื่อ\nสั่งอย่างอื่นเพิ่มอีก สั่งบ้างดีกว่า"

"ยังไม่อิ่มเลย แถมหนึ่งจานก็ได้ค่อนข้างน้อย ที่สำคัญที่สุดคือชิซูเนะเป็นคนเลี้ยงด้วย พอคิดเช่นนั้นแล้วก็สั่งแซนด์วิชอีกที่\nกับยูโกะ"
...
"กว่าจะออกจากร้านก็ผ่านไปไม่เพียงคาบเดียว แต่เป็นถึงสองคาบ"

scene bg suburb_roadcenter
with locationchange

"ชิซูเนะกับมิช่าดูจะพอใจที่ปล่อยให้เวลาทั้งวันไหลไป แถมยืดอีกด้วยการพาเดินในเมืองที่อยู่ในระยะสองช่วงตึกจากร้านนั้น"

scene bg school_scienceroom
with shorttimeskip

"สุดท้ายพวกเราก็กลับโรงเรียนกัน ที่เหลือก็ตามปกติ พอเลิกเรียนแล้วชิซูเนะกับมิช่าก็เก็บของออกห้องไปก่อนแล้ว จะว่าไป\nครั้งแรกเลยมั้งที่สองคนนั้นทิ้งฉันไว้คนเดียว"

"แปลก เหมือนจะเหงา คนก็ออกจากห้องไปจนหมดอย่างรวดเร็ว เหลือฉันคนสุดท้ายที่ออกประตู"

scene bg school_lobby
with locationchange

"พอมาถึงโถงแล้วก็มีมือมากั้นเหมือนด่านทางด่วนไม่ให้ไปไหน"
...
"อีกสองมือจากข้างหลังมาปิดตาเอาไว้ ตามด้วยเสียงหัวเราะลั่น"

mi "ไงฮิจัง~! ทายซิใครเอ่ย!"

"มิช่าถามโดยไม่มีน้ำเสียงประชดแต่อย่างใด แปลว่าเธอคงคิดว่าฉันจะไม่รู้ว่าเป็นเธอจริง ๆ ทั้งที่ชัดขนาดนี้"

hi "ใครกันนะ อืม ไม่ใช่มิช่าแน่ ๆ ละ…"
...
"มิช่าหมุนตัวย้ายมาอยู่ข้างชิซูเนะตรงหน้าฉัน"
...
hi "ไม่ว่าง กำลังกลับห้อง เจอกันพรุ่งนี้!"
...
"ฉันพยายามหนี ทว่าชิซูเนะเร็วเกินหนีทัน รู้สึกอายขึ้นมาทันทีในฐานะนักบอลเก่า แล้วยิ่งทำแบบนี้คนก็มองแปลก ๆ อีก\nรู้งี้ยอมไปเสียแต่แรกก็ดี"
...
mi "ฮิจัง ไปเอาของที่ห้องศิลปะชั้นบนให้หน่อยสิ"
...
mi "ฮ่าฮ่าฮ่า~! ชิจังคิดว่าถ้าครูศิลปะมาเห็นพวกเราก็จะทักทายน่ะสิ แล้วชิจังก็ไม่ชอบเขาด้วย!"
...
mi "เคยลองแล้ว แต่ถึงชิจังจะหูหนวก ก็จะเข้ามาทักทายว่า “ไง~!” อยู่ดี!"
...
"อารมณ์ยื่นคำขาดส่งมาแรงจนรู้สึกได้แม้มิช่าจะเป็นคนพูด จะมัวแต่ดื้อด้านเถียงกับชิซูเนะก็คงเปล่าประโยชน์"

hi "แล้วทำไมเธอไม่ไปล่ะมิช่า"

show misha sign_smile
with charachange

mi "ฉันเดินบันไดแล้วเวียนหัวอะฮิจัง!"
...
"ชิซูเนะพยักหน้าคล้ายยืนยัน"

show misha perky_sad
with charachange

mi "เถอะนะ ฮิจัง พวกเราต้องใช้ของพวกนี้ไปทำแผงในงานเทศกาลน่ะ แล้วนายก็บอกว่าจะช่วยหน่อยด้วย ใช่มั้ย ๆ"

"จริง ๆ ก็ไม่ควรช่วยเรื่องนี้เท่าไหร่ แต่แค่ครั้งนี้ครั้งเดียวคงไม่เป็นไร"
...
mi "เยี่ยมเลยฮิจัง! ขอบคุณนะ~!"

show misha perky_smile
with charachange

mi "อันนี้ของที่ต้องใช้!"

"เธอยื่นกระดาษมาให้ฉันรับไว้"

"ชิซูเนะเป็นคนทำแน่ ๆ เขียนด้วยลายมือที่บรรจงเป็นระเบียบอย่างดีราวกับพิมพ์มา แล้วยังมีรายละเอียดครบถ้วนแยก\nเป็นข้อ ๆ มีจำนวน ทั้งกล่องที่เอาไว้ติ๊กถูกด้วย"

"สรุปก็คือจะใช้สี แปรง กระดาษแข็ง ขาตั้ง โดยแต่ละอย่างเป็นชนิดต่าง ๆ กัน แล้วก็มีบอกจำนวนสำหรับของแต่ละชนิด\nแล้วนี่ฉันจะขนของพวกนี้เดินลงบันไดมายังไงไม่ให้คอหักไปก่อน"
...
"ฉันยังไม่ทันจะได้เปิดกล่องข้าวลิลลี่ก็ไปง่วนอยู่กับกระบอกน้ำเก็บความร้อนและถุงชา ส่วนฮานาโกะก็เตรียมกล่องข้าว\nสำหรับทั้งพวกเธอสองคน"
...
"ถึงแม้ชิซูเนะจะเป็นใบ้ แต่เธอก็เป็นคนตรง ๆ ลุย ๆ ส่วนมิช่าก็ดูจะเข้ากับทุกคนได้ ในขณะที่ลิลลี่จะเป็นคนพูดจา\nอ่อนหวานและใจเย็น และฮานาโกะคงจะเป็นผู้หญิงที่ขี้อายที่สุดเท่าที่ฉันเคยเจอมา"

li "อยู่ยามากุเป็นยังไงบ้างจ๊ะฮิซาโอะ ก่อนหน้านี้เห็นเธอจะว้าวุ่นใจ"
...
"มีแวบหนึ่งที่นึกจะเล่าเรื่องอาการของฉันให้ฮานาโกะกับลิลลี่ฟัง แต่ก็ไม่พูด"
...
"ที่นี่คงมีกฎที่รู้กันอยู่อย่างหนึ่งคือ “ห้ามถาม” ต่อให้อาการของคนนั้นจะเห็นชัดเหมือนฮานาโกะ เพราะยังไงก็ต้องมีที่มาที่ไป"
...
"ไม่นานระฆังก็ดังเตือนว่าหมดพักเที่ยงแล้ว ทั้งฉันทั้งพวกเธอสองคนต่างเก็บข้าวของอย่างคล่องแคล่วเหมือนตอนจัดเตรียม"
...
"ฉันไม่รู้จะว่ายังไงดี ฮานาโกะเป็นคนเปราะบางเสียจนแค่มองผิดทางก็ทำให้แตกสลายได้แล้ว เล่นเอาฉันเกร็งหน่อย ๆ\nด้วยเลย แต่ฉันพยายามไม่คิดอะไรแล้วทำตัวให้เป็นธรรมชาติเท่าที่จะทำได้"

show tearoom_hisaoe hsmile
with charachange

hi "งั้นก็รีบไปกันเลยดีกว่า เหมือนว่าคาบเรียนจะเริ่มแล้วด้วย"
...
"พวกเราสาวเท้ามาที่โถงทางเดินโล่งที่พาไปยังห้องเรียนของแต่ละคน"

"และเมื่อถึงประตูห้องเรียน 3-2 ของลิลลี่เธอก็หันมาทางฉัน"
...
"พอลิลลี่พูดจบพวกเราก็แยกทางกัน ลิลลี่เดินเข้าห้องเรียนของเธอปล่อยให้ฉันและฮานาโกะเดินไปยังห้องของตัวเอง\nดูท่าทางของฮานาโกะแล้วเหมือนอยากจะหนี"
...
"และลิลลี่ก็พูดถูก ยิ่งเข้าห้องช้าเท่าไหร่ก็ยิ่งต้องแก้ต่างกับครูมากเท่านั้น"
...
"ทว่าพอเห็นฮานาโกะที่เดินตามเข้ามาแล้วปิดประตูก็แค่พยักหน้าให้แล้วสอนต่อ"

"รอบนี้ก็รอบที่สามแล้วที่ไม่มีใครว่าอะไรฮานาโกะเรื่องการเข้าเรียน ต้องมีอะไรสักอย่างแน่ ๆ"
...
"ฉันทำตัวให้ปกติแล้วหยิบหนังสือวิชาที่เรียนออกมาจากกระเป๋าและเปิดตาม"
...
"เมื่อระฆังเลิกเรียนดังก็รู้ตัวว่ายังมีเวลาเหลืออีกมากสำหรับวันนี้ ฉันจึงนั่งคิดว่าจะทำอะไรดี"
...
"ครูกำลังใช้ปากกาแดงตรวจงานที่เพิ่งทำกันไปเมื่อครู่อยู่"
...
"ฉันสะดุ้งที่ครูทัก แต่ก็คงไม่แปลกที่จะคุยเพราะไม่เหลือใครอยู่ในห้องแล้ว"

hi "เอ่อ… ไม่มีอะไรครับ แค่คิดอยู่ว่าเลิกเรียนแล้วทำอะไรดี"

"ครูค่อย ๆ ปิดฝาปากกาที่ถืออยู่แล้วจัดกระดาษเข้าให้เป็นกองและเคาะกับโต๊ะสองที"

"เป็นคนดูมีระเบียบจนนึกถึงชิซูเนะขึ้นมาแวบหนึ่ง แต่ครูค่อนข้างสบาย ๆ ไม่รีบร้อนมากกว่า ทำอะไรซ้ำ ๆ เดิม ๆ"
...
hi "ผมไม่รู้ว่าต้องทำตัวยังไงกับ… ความพิการน่ะครับ แบบ… ถ้าจดจ่ออยู่กับมันไปเลยก็เสียมารยาท แต่จะเมินไปเลยก็แปลก ๆ"
...
"ครูมุโต้ดูเอือมที่ถูกขัดและเอือมกับมิช่าด้วย ครูทิ้งตัวลงกับพนักเก้าอี้"
...
"แต่มิช่าก็ไม่เบาเสียงลงเลย คุณครูได้แต่ขยี้ตา"
...
mu "อ้าว แล้วครูจะไปรู้ได้ยังไง"

show misha perky_confused
with charachange

mi "ชิจัง… เอ่อ คือประธานเขาคิดว่าครูคงรู้ว่าไม้อัดอยู่ไหนน่ะค่ะ คิดผิดเหรอคะเนี่ย"

"ครูมุโต้ดูปวดหัวเอามาก ๆ หน้านิ่วคิ้วขมวดขั้นสุด แต่มิช่าก็ยังไม่รู้เรื่อง"
...
"มิช่าใช้ทั้งสองมือกุมหัวทำท่าทางให้ดูสิ้นหวังที่สุดเท่าที่คนอย่างเธอจะทำได้และขยำกระดาษที่ถือไว้บนหัวโดยไม่รู้ตัว"

mi "ไม่น่ามาเป็นธุระให้เลย แค่งานที่ต้องทำก็มีเยอะแล้ว แถมจะไม่ทันกำหนดอีก!"
...
"ครูมุโต้จ้องมิช่าเขม็งและจู่ ๆ ก็ยิ้มขึ้นมา รอยยิ้มดูไม่เข้ากับหน้าของครูเท่าไหร่ ถ้าไม่ยิ้มน่าจะดีกว่า"
...
"ครูเบนสายตาจ้องมองมาทางฉันด้วยสีหน้าหนักแน่น คล้ายจะบอกว่า “ไปหาเพื่อนซะ”"
...
"มิช่าชะงักไปเหมือนนึกอะไรได้ จากนั้นชี้นิ้วมาที่ฉันแล้วร้อง “อ๊ะ!” ออกมาด้วยสีหน้างุนงง"
...
"ครูมุโต้ถอนหายใจพรืด รู้สึกว่าคงต้องช่วยมิช่าเพื่อให้เธอยอมไปจากคุณครูสักที"
...
"เธอยื่นแผ่นกระดาษที่ถือมาให้ ฉันรับมาด้วยความลังเล"
...
"มิช่าโลดเต้นออกจากห้องไป ทิ้งไว้เพียงฉันกับคุณครูที่เงียบไปเหมือนรู้กัน"
...
"ห้องเรียนที่อยู่ใกล้ห้องของพวกเราที่สุดทางด้านขวาคือห้อง 3-1 กับห้อง 3-2 ส่วนทางด้านซ้ายเป็นห้อง 3-4\nและประตูแต่ละบานก็เหมือนกันทุกประการ"
...
rin "ฉันจะไม่จับมือนายนะ แต่อย่างน้อยตอนนี้ก็รู้จักกันแล้ว"
...
rin "ไม่ มาโรงเรียนนี้ทำไม นายก็ดูปกติดี ข้างในนายพิการเหรอ"
...
"รินคาบส้อมเอาไว้แล้วเอนตัวพิงกำแพงมองเพดานคล้ายว่ามีคำตอบเขียนอยู่บนนั้น"
...
"รู้สึกเหมือนตัวเองอึ้งหงายหลังล้มตึงไปพร้อม ๆ กับตอนที่รินเบิกตาขึ้นด้วยความทึ่งเมื่อได้ระลึกได้ดังนั้น"
...
"ฉันสะดุ้งที่อยู่ ๆ มิช่าก็โผล่มาเพราะไม่ได้ยินเสียงใครเดินมาทั้งที่โถงทางเดินก็ไม่มีใคร"

"มิช่าเข้ามาในระยะที่พอจะทำให้ฉันตกใจได้โดยไม่มีการให้สุ้มให้เสียง น่ากลัวแฮะ อยู่ ๆ ก็นึกถึงทฤษฎีบ้า ๆ\nของเคนจิเรื่องสตรีนิยมครองโลก แต่ฉันก็ปัดความคิดนั้นทิ้งทันที"
...
"และก็ใช่จริง ๆ ชิซูเนะยืนตัวค้างจ้องริน ไหล่เธอสั่นเล็กน้อยพอสังเกตได้ คงกลั้นความโกรธไว้อยู่แน่ ๆ "
...
"ดูไม่ออกเลยว่ารินโอเคหรือไม่โอเคที่เรื่องเป็นแบบนี้"

"แต่เรื่องของเรื่องก็คือรินไม่ได้สนใจที่ชิซูเนะหรือมิช่าต่อว่าอย่างนั้น ทั้งสองคนก็ได้แต่จำใจไม่ว่าอะไรอีก"
...
"เมื่อมิช่าแปลคำตอบนั้นให้ชิซูเนะฟังเธอก็ขมวดคิ้วด้วยความไม่พอใจ"
...
"รินเตะเบา ๆ ใส่ถังสีใหญ่ที่นอนแอ้งแม้งอยู่บนพื้นข้างโต๊ะที่เธอใช้นั่งกับหลับอยู่"
...
"ไม่ฉันก็รินสักคนที่เดินช้าหรือเร็วไป ซึ่งฉันก็ไม่รู้ว่าเป็นอย่างไหน"
...
nk "เรื่องยาน่ะ เพราะเธอเพิ่งใช้ยาที่หมอสั่งมาได้ไม่นานเลยอาจจะมีผลข้างเคียงที่ไม่คาดคิด แล้วอาจจะได้ปรับปริมาณ\nการใช้ยาหรือไม่ก็ต้องเปลี่ยนตัวยาเลย"
...
"รอยยิ้มโง่ ๆ นั้นหายไปจากใบหน้าของคุณพยาบาลชั่ววินาทีหนึ่ง แล้วก็กลับมาเหมือนไม่ได้หายไปไหน"
...
nk "ถ้าพรุ่งนี้เช้าเธอไปที่ลู่วิ่งแล้วจะได้เจอกับ “สายลับ” ของฉัน ถ้าเธออยากวิ่ง เขาก็คงพร้อมให้คำปรึกษา\nโดยไม่อิดออดเลย"
...
"คุณพยาบาลโบกมือลาโดยไม่ตอบ ฉันเดินไปหารินที่ยืนพิงผนังโถงทางเดินเหม่อมองจ้องไฟสีตุ่น ๆ บนเพดานรออยู่"
...
hi "แค่ให้มันแย่น้อยลงหน่อยหนึ่ง"
...
"ตลอดแนวกำแพงที่สร้างด้วยอิฐแบบเดียวกันกับที่ใช้ทำตึกนั้นมีภาพเขียนอยู่"
...
rin "…นั่นแหละ ฉันถึงได้นึกอยู่ว่ามีอะไรที่ฉันต้องนึกได้และต้องนึกให้ได้ก่อนจะสายเกินจนสิ้นหวัง"
...
"ฉันยังงง ๆ นิดหน่อยที่รินเป็นคนวาดภาพ แต่ดูจากความคล่องที่ใช้เท้ากินข้าวนั้นแล้วก็นึกได้ว่าคงวาดภาพได้\nไม่มีปัญหา"
...
"รินก็ดูตกลงให้ฉันช่วยเร็วเหลือเกินไม่ต่างอะไรกับชิซูเนะ จนทำให้รู้สึกว่างานเทศกาลเป็นงานใหญ่ที่ทุกคนต้องช่วยกัน\nคนละไม้คนละมือ"
...
"แล้วเธอก็นั่งลงที่ลังไม้เปล่าและใช้เท้าขวาคีบแปรงทาสีขึ้นมา"
...
"รินหยักยิ้มที่มุมปากเล็กน้อย"

rin "นายไม่มีความเห็นเป็นของตัวเองเหรอ"

hi "ไม่ใช่งั้นสิ ก็ฉันไม่รู้นี่"
...
"พอเห็นภาพวาดหนึ่งปรากฏบนกำแพงปลาสเตอร์แล้วรู้สึกราวกับมีเวทมนตร์"

"ฉันใช้เวลาไปกับการนั่งที่ทางเดินผสมสีและมองภาพเขียนของริน"

"ทีแรกก็รู้สึกเหมือนรบกวนนิดหน่อย เหมือนมาขัดอะไรสักอย่างที่มองไม่เห็น แต่รินก็ดูจะไม่ว่าอะไรเลย คงคิดไปเองมั้ง"

"บรรยากาศรอบตัวรินต่างจากปกติยามเธอจดจ่อกับการลงรายละเอียด เพิ่มสีลงอีกชั้นทับอีกสีหนึ่ง ค่อย ๆ\nขยับเท้าเธอไปตามกำแพงแต่งเติมรูปร่างใหม่ ๆ "
...
"พวกเราอยู่กันจนค่ำมืดเกินกว่าที่จะทาสีได้"
