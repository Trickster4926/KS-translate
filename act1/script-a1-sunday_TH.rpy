...
"ก็ตลกดี นึกว่าถ้าแพ้เกมโง่ ๆ ของชิซูเนะแล้วจะเจออะไรหนัก ๆ เสียอีก อันนี้แค่ข้ออ้างอยากอยู่ด้วยกันมากกว่า ถ้างั้น\nก็คงแค่อยากให้ฉันได้สนุกแหละ"

"แม้ชิซูเนะจะไม่ได้บอกเจตนาออกมาตรง ๆ แต่อย่างไรก็คงเป็นเจตนาที่ดีแหละนะ ชักชอบเธอขึ้นมาแล้วสิ"
...
ke "ฉันนึกภาพออกเลยเวลานั่งวางแผนกันเพื่อผลักดันแนวคิดสตรีนิยม ฉันวางใจองค์กรแบบนั้นไม่ลงหรอก"
...
ke "พลาดละ พลาดมาก นายไม่รู้หรอกในชมรมศิลปะจะมีผู้หญิงแบบไหนบ้าง อาจจะมีพวกหน้าซื่อใจเศร้าที่จะกะซวก\nอกนายควักหัวใจออกมากิน"
...
hi "นั่นดิ… ก็หิว ๆ แล้ว แต่ก็ตกลงไปแล้วว่าจะดูแลตัวเองให้ดีขึ้น แบบว่าให้สุขภาพดีอะไรงี้"
...
"ฉันคิดอยู่ว่าจะทำอะไรตอนอยู่กับชิซูเนะกับมิช่าดี พอคิดได้ว่าเตรียมไว้ก่อนจะดีที่สุดฉันก็กลับเข้าห้องไปเอาเงิน\nตุนเข้ากระเป๋าสตางค์"
...
"หวังว่าจะไม่ได้ยินนะ แต่มิช่าคงอยากให้ได้ยินน่ะแหละ"
...
mi "มาเถอะ ไปกัน! นอกห้องนายวงดนตรีคนหูหนวกเขากำลังเตรียมจัดกันเลยนะ"

"มิช่าคว้าแขนฉันแล้วลากให้ฉันออกมาจากประตู แต่ชัดว่าเธอจงใจไม่ใส่แรงเลย"
...
"สมองยังไม่ทันประมวลผลสิ่งที่เกิดขึ้นมิช่าก็หัวเราะก่อนแล้ว ส่วนชิซูเนะก็ยิ้มให้ฉัน คงเป็นครั้งแรกที่เธอยิ้มจนเกือบ\nจะหัวเราะอย่างนี้"
...
"อย่างที่หนึ่ง เกมนี้เป็นเกมที่ให้ปาบอลใส่กองขวดใสเพื่อล้มขวดให้ได้มากที่สุด"
...
"ชิซูเนะดึงแขนเสื้ออย่างร้อนใจแล้วกอดอก ขมวดคิ้วราวแสดงความไม่พอใจของตัวเองที่ฉันหันไปสนใจอย่างอื่น"
...
"จะว่าไปแล้ว นี่ฉันต้องโง่ขนาดไหนถึงพูดอยู่กับคนหูหนวกเนี่ย คงไม่ได้ยินหรอก"
...
"ชิซูเนะยืนขึ้นด้วยความหงุดหงิดแล้วเอามือไพล่หลัง ท่าทางดูองอาจและมีอำนาจนั้นยืนอยู่ต่อหน้าผืนฟ้าดวงดาว"
...
"อยู่ ๆ ชิซูเนะก็อ้าแขนออกกว้างราวกับจะคว้าท้องฟ้าผืนนั้นไว้กับตัว"
...
"ความรู้สึกคลับคล้ายความรังเกียจเข้าครอบงำ เป็นความรู้สึกผิดที่ฉันใจแคบ"
...
"เอมิฉวยของกินไปจากมือฉันแล้วจ้องจี่"
...
"แล้วเอมิก็แสยะยิ้มชั่วร้ายขึ้นมา"
...
hi "คือเมื่อวานเธอก็โน้มน้าวใจฉันได้แล้วไม่ใช่เหรอว่าทำอย่างนี้ก็ดีเหมือนกัน"

hi "ไม่ต้องมาขออีกรอบหรอกน่า"   
    
"แต่ก็ใช่ว่าฉันจะเชื่อฟังได้ดีขนาดนั้นอะนะ"
 
"เพราะยังไงเอมิก็พูดถูกเรื่องการกินให้มันดีต่อสุขภาพมากขึ้น ฉันกลับมาซื้อของกินที่ไม่ดีต่อสุขภาพอย่างน่ารังเกียจ\nอย่างนี้"
...
"ประมาณว่ากินสั่งลาของทั้งหลายที่ฉันสวาปามกินดะไปตอนก่อนเข้าโรงพยาบาล"
...
"ดูจะเป็นห่วงสุขภาพฉันจริง ๆ"

"ต้องตอบแทนเอมิสักทาง"
...
"ฉันจำไม่ได้ว่าในงานเทศกาลจะมีจัดอะไรบ้าง ถึงวันก่อนครูมุโต้จะบอกไปแล้วในคาบก็เถอะ"
...
"อาการปวดขาจากการวาดของเธอคงหนักกว่าที่เธอแสดงออก ทีแรกก็นึกว่าแค่กล้ามเนื้อล้าหรืออะไรอย่างนั้น\nฉันหมายจะถามต่อ แต่รินก็เปลี่ยนเรื่องไปอย่างหน้าตาเฉย"
...
rin "เมื่อวานฉันคิดว่าทำอะไรเสร็จหมดแล้ว แต่ตอนนี้ดันไม่แน่ใจอีก น่าจะเติมรายละเอียดอีกหน่อย มั้งนะ อาจจะ\nเลือกไม่ถูกเหมือนกัน"
...
"คำถามของฉันเรียกให้รินหลุดจากภวังค์ เธอหันหน้ามาทางฉันอย่างเอื่อย ๆ "
...
"ฉันรู้สึกเหมือนจะแก้ต่างให้เธอมากกว่าตัวของฉันเอง แต่ก็ใช่ว่าฉันตื่นเต้นกับงานเทศกาลอะไรขนาดนั้นหรอก\nแค่อยากรู้ว่างานมันเป็นยังไงก็แค่นั้น"
...
"ตาของรินเคลื่อนไหวจากคนนั้นไปคนนี้ที่เดินผ่าน"

"รอใครสักคนให้มาแวะที่ภาพเขียนหรือเปล่านะ หรือแอบหวังว่าจะมีคนมาติชมอะไร"

"คงไม่มีใครคิดว่ารินเป็นคนวาดหรอก พวกเราทั้งคู่มานั่งอยู่ด้วยกันอย่างกับคนไร้บ้าน แล้วเธอไม่ก็มีมืออีกต่างหาก"
...
"เธอไม่ตอบในทันที แต่ตอนนี้ฉันก็ค่อนข้างชินแล้วที่บางครั้งรินจะพูดอะไรช้าไปบ้างเหมือนคอยเลือกสรรคำ\nอย่างถี่ถ้วนอยู่ ซึ่งออกจะเหลือเชื่อถ้าดูจากอะไรแต่ละอย่างที่ออกมาจากปากของเธอ"
...
"รินมองมาทางฉันทำสีหน้าชวนขัน แต่ก็ไม่พูดอะไร"
...
"จู่ ๆ รินก็เด้งตัวลุกขึ้นยืน ฉันตกใจเพราะนึกว่ายังปวดขาเดินไม่ได้อยู่ แต่ดูเหมือนจะหายแล้ว"
...
"เมื่อรินลืมตาขึ้นมา นัยน์ตาสีเข้มอันเรียบนิ่งน่ากลัวนั้นทำฉันผงะไป"
...
"สุดท้ายก็กลับมา อยู่ ๆ รินก็โผล่มาแล้วมานั่งลงที่เดิมข้าง ๆ ฉัน"
...
rin "เหตุผลนายฟังดูเข้าท่ากว่าทุกเหตุผลที่ฉันคิดไว้อีก"
...
"รินปรับท่านั่งแล้วเอนกับกำแพง ฉันก็ทำตัวให้สบายอย่างเธอบ้าง"

"เรานั่งเงียบไม่พูดไม่จากันอยู่หลายนาที"

"ฉันลองจับอารมณ์ของรินดูจากท่าทาง ความเกร็งของกล้ามเนื้อ เศษเสี้ยวสีหน้าอารมณ์ที่โผล่มาได้แวบหนึ่ง\nแต่ก็เปล่าประโยชน์ ยังเป็นคนที่ดูไม่ออกเหมือนเดิม"
...
"ผู้คนเดินกันพลุกพล่านคุยกันจอแจ มีน้อยคนที่จะสนใจภาพเขียนผนังจริง ๆ ไม่ต้องนับว่ามีคนที่สนใจเราด้วยหรือเปล่า\nด้วยซ้ำไป"
...
"รินหลับตาพริ้มปากเผยอเล็กน้อย เป็นใบหน้ายามหลับที่ดูใสซื่ออย่างเด็ก ๆ "
...
"รินลืมตาขึ้นมาช้า ๆ แต่ก็ยังไม่เบิกเต็มที่ เปิดเพียงพอให้แสงสว่างจ้าจากพลุที่แตกลอดผ่านขนตาเธอมาสะท้อน\nกับนัยน์ตาสีเขียวของเธอได้ เธอมองมาทางฉันแล้วขมวดคิ้ว"
...
"เหมือนจะยังไม่รู้ตัวดีว่าเกิดอะไรขึ้น"
...
"พลุดอกสุดท้ายประกายสีเงินและน้ำเงินแล้วดับไป ทิ้งไว้เพียงความเงียบอันวังเวงครู่หนึ่งก่อนคนจะทยอยกันออกไป\nที่ประตูหลักอย่างฝูงวัวควาย"
...
"ตามหม้อและกระทะที่ต้มน้ำอยู่มีไอตลบอยู่ทั่ว นักเรียนส่วนใหญ่ต่างแกะห่อวัตถุดิบกันอยู่โดยมีคนที่น่าจะเป็น\nครูประจำชั้นห้อง 3-2 คอยช่วยด้วย"

"ไม่นานก็เห็นลิลลี่ที่อยู่ในกลุ่มนั้นด้วย เธอกำลังคุยกับครูอยู่พลางใช้นิ้วนับจำนวนกล่องและถุงแบบเร็ว ๆ"

"ดูจากสีหน้าท่าทางของทั้งลิลลี่ทั้งครูที่งง ๆ กันอยู่แล้ว น่าจะมีปัญหาเรื่องการสื่อสารอะไรกันสักอย่าง"
...
"ไม่นานก็มีคนนำซุปที่ทำเสร็จแล้วมาส่งให้ลิลลี่อย่างระมัดระวัง แล้วเธอก็ส่งมาให้ฉันอีกต่อหนึ่ง"
...
"ลิลลี่ถอนหายใจเบา ๆ ดูผิดหวังอย่างแรง"

li "ไม่เป็นไรจ้ะ ฉันแค่อยากรู้ว่าฮานาโกะจะทำอะไรที่งานเทศกาลน่ะ"
...
"ฉันเดินจากแผงมาแล้วหาที่นั่ง มือประคองถ้วยไม้ที่ควันฉุยไว้ด้วยสองมือ"
...
"ภารกิจของครูนั้นดูท่าจะสำเร็จ ที่แผงมีนักเรียนทำงานอยู่กันสิบกว่าคน และของส่วนใหญ่ก็แกะห่อเรียบร้อยแล้ว"
...
"ฉันเลื่อนถ้วยไปที่มือลิลลี่ เธอรับไปแล้วส่งให้อีกคนที่เหมือนจะรับหน้าที่ล้างชามอยู่ คงให้มาทำตำแหน่งนี้\nเป็นการลงโทษที่มาสาย เพราะฉันไม่เคยเห็นหน้าคนที่อยู่ตรงนั้นมาก่อนเลย"
...
"ลิลลี่ชะเง้อหน้าหันมาแล้วกลับมาที่เคาน์เตอร์เมื่อได้ยินเสียงฉันที่ยังไม่ไปไหนอีกครั้ง"
...
"ลิลลี่ทำแก้มป่องไม่พอใจ ดูน่ารักขัดกับท่าทีสุขุมตามปกติของเธอดี"
...
"ฉันคิดว่าลิลลี่คงจะอยู่หอมาตั้งแต่ที่เธอมาเข้าเรียนที่นี่ แต่แล้วก็นึกถึงสิ่งที่เธอพูดเอาไว้เมื่อวานขึ้นได้"
...
"ลิลลี่ทำสีหน้าเข้าใจยาก จนรู้ได้เลยว่าสิ่งที่ฉันพูดไปโดนเข้ากับประเด็นที่อ่อนไหวสักอย่าง"
...
"คำถามย้อนกลับของฉันเล่นเอาลิลลี่ไม่ทันตั้งตัว"

li "ฉันก็อยู่ที่นี่มาได้สักพักแล้ว เพราะงั้น…"

hi "ไม่ใช่อย่างนั้น คือเห็นเธอเครียดเรื่องพี่อากิระน่ะ"
...
li "พี่อากิระเขามีแฟนแล้วจ้ะ ต้องขอโทษด้วยนะจ๊ะฮิซาโอะ"
...
ha "ฉันก็นึกว่า… ลิลลี่จะไม่สนุกกับงานเทศกาลเสียอีก"
...
"ฉันยื่นเหรียญให้สาวที่เฝ้าแผงอยู่แล้วถือชาที่ใส่ถ้วยโฟมมาสองใบแล้วโค้งหัวให้เห็นชัด ๆ เพื่อชดเชยให้ที่เธอหูหนวก"
...
"ลิลลี่หันหน้ามาเล็กน้อยให้เห็นว่าเธอฟังอยู่ สายตาของฮานาโกะยังคงจดจ่ออยู่กับพลุสีแจ่มแจ้งที่กระจายอยู่บนฟ้า"
...
hi "นี่ลิลลี่ ไม่ต้องเป็นห่วงฮานาโกะหรอก เดี๋ยวฉันไปอยู่เป็นเพื่อนเอง นะ?"
...
hi "ได้สิ โชคดีนะ แล้วก็อย่าลืมพักด้วยนะ โอเคไหม"

show lilly basic_smile
with charachange

li "จะพยายามจ้ะ ไว้เจอกันนะจ๊ะฮิซาโอะ"
...
"ฉันเดินสวนทางฝูงชนคนหมู่มากไปตามสัญชาตญาณอันแสนจะทึมทึบของฉัน"
...
"แม้แต่นักเรียนที่ขยันเรียนสุด ๆ ก็คงไม่อยากมาแนะนำที่บริเวณนี้ของโรงเรียน"

play music music_happiness fadein 2.0
scene bg school_library
with locationchange

"ทันทีที่ก้าวเข้ามายังห้องสมุดเสียงจากงานเทศกาลก็เงียบลงไปเป็นเสียงอู้อี้ และฉันก็เดินเข้ามาในบริเวณอ่านหนังสือที่\nอยู่หลังห้อง"

"หลังโต๊ะอ่านหนังสือตัวหนึ่งฉันเห็นหัวที่มีผมตรงสีเข้มสะดุดตา"
...
hi "เอ้อ ตอนนี้ลิลลี่ยุ่งมากเลยละ เลยส่งฉันมาตามหาเธอนี่แหละ"

show hanako basic_normal at center
with charachange

ha "อะ… อ๋อ นายอยากจะนั่งไหม"

hi "จริง ๆ ตอนนี้ก็หิวนิดหน่อย เธอจะไปหาซื้ออะไรมากินจากแผงหน่อยไหม"
...
"ฮานาโกะปิดและเก็บหนังสือของเธอด้วยท่าทีที่ดูจะทำจนชินแล้ว"
...
"พวกเราเดินเคียงกันจากห้องสมุดไปยังห้องน้ำชา"

"ซึ่งอย่างที่คาด แถวนี้แทบไม่ค่อยมีคนเลย"

"ถ้าไม่ได้มีเสียงเล็ดลอดผ่านมาทางกำแพงก็จะไม่รู้เลยว่าข้างนอกมีงานเทศกาลใหญ่กำลังจัดกันอยู่"

show hanako emb_downtimid at tworight
with charaenter

"ฮานาโกะถือกระเป๋าตัวเองด้วยมือทั้งสองข้างและจดจ้องไปที่พื้นข้างหน้าเธอ"
...
"เหมือนจะก้าวช้าลงเล็กน้อยและก้าวสั้นลงเป็นระยะ ๆ"

"ตอนแรก ๆ ที่ฮานาโกะทำฉันก็ไม่ได้ใส่ใจอะไร แต่ว่าไม่นานฉันก็สังเกตเห็นว่าเธอทำมาตลอดทาง"
...
"ฉันนึกอยู่แวบหนึ่งว่าคงไม่ตอบหรอก"
...
"ฮานาโกะค่อย ๆ ลากเท้าไปมาแล้วใช้ปลายรองเท้าชี้ไปที่กระเบื้องแผ่นหนึ่งซึ่งเข้มกว่าแผ่นอื่น ๆ แค่หน่อยเดียว"
...
"เธอพยักหน้าอีกรอบ แต่รอบนี้ดูกระตือรือร้นมากกว่าเดิมนิดหน่อย"
...
"ฉันเคยเห็นฮานาโกะทำแบบนี้หลายครั้งแล้วละนะ แต่ครั้งนี้เธอดูต่างออกไปนิดหน่อย"

"อย่างกับว่าเธอรู้สึก…{w} ผ่อนคลาย"

"แล้วเธอก็วางถาดใบเล็กลงบนโต๊ะแล้วรินชาลงถ้วยสองใบ"

"กลิ่นชาที่ชงใหม่ ๆ ลอยเคล้ามากับลมเย็น ๆ ทำให้รู้สึกราวกับทั้งโลกใบนี้มีเพียงแค่ฉันคนเดียว"
...
"พวกเราตั้งกระดานก่อนที่จะเริ่มเดินเบี้ยออกไปยังชะตากรรมที่ไม่อาจหลีกเลี่ยงของมัน"
...
"ฮานาโกะถามอย่างกับว่ากำลังขอให้ฉันทำเรื่องคอขาดบาดตายเลย จิตวิญญาณนักแข่งเข้าสิงหรือไงเนี่ย"
...
"เคนจิปิดประตูไป เสียงลงกลอนตามมา"
...
"ช่วงนี้หนีหน้าหน่อยดีกว่า เพราะพวกเธอไม่น่ายกโทษให้ฉันง่าย ๆ แน่ ๆ ที่ปล่อยให้ทำงานกันสองคน"
...
"เคนจิยืนขึ้น ฉันนึกทึ่งเพราะฉันยังไม่แน่ใจเลยด้วยซ้ำว่าตัวเองจะยืนขึ้นอย่างนั้นไหวหรือเปล่า เขาตะเบ็งเสียง\nโดยไม่สนใจว่าเสียงจะดังแค่ไหน เล่นเอาฉันผงะแทบยกมือขึ้นมาปิดหู"
...
"เคนจิทิ้งตัวพิงกับรั้วแล้วหรี่ตา"
...
"เขาทำท่าเข่าทรุดแล้วล้มตัวลงนอนตะแคงกับพื้นกรวดที่ปูบนดาดฟ้าแห่งนี้"

hi "เฮ้ย ไหวปะเนี่ย"

ke "ไม่ ไม่ไหว ไม่เห็นเหรอว่าฉันผิดหวังอยู่"

"น้ำเสียงเคนจิประชดประชันเต็มที่"
...
"จู่ ๆ เขาก็เด้งตัวลุกขึ้นนั่งแล้วปัด ๆ ตามเนื้อตัวก่อนจะยื่นมือมาคว้าขวดที่อยู่กับฉัน ฉันยื่นให้เขากับมือ"
...
"ฉันเวียนหัวจนซวนเซ มือจับเสารั้วประคองตัวไว้ แต่พอทิ้งตัวก็รู้สึกได้ว่าเสานั้นรับน้ำหนักไม่ไหวแล้ว"
