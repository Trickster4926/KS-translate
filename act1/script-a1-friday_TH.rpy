...
"ฉันฟังเสียงหัวใจตัวเองอยู่ครู่หนึ่งเพื่อกลบเสียงที่คุณพยาบาลนั่งพิมพ์กับคอมพิวเตอร์อยู่ และกลบเสียงหอบ\nของฉันเองด้วย"
...
hi "อืม ก็ได้ ใช่ “มี” นั่นแหละ แต่ฉันไม่อยากคุยเรื่องนี้ ไม่อยากคุย…ตอนนี้"
...
"เสียงเธอหัวเราะคิกคักบีบฉันให้ต้องพูดอะไรต่อเพื่อไม่ให้เธอเข้าใจผิด"
...
"ทั้งที่รินดูเหมือนจะเป็นคนเงียบ ๆ แต่เธอกลับใช้คำได้ยืดเยื้อฟุ่มเฟือยเอามาก ๆ "
...
"สงสัยน้ำประปาแถวนี้มีอะไรผสมอยู่แน่ ๆ ฉันนึกเตือนตัวเองในใจให้ซื้อน้ำอัดลมไว้ดื่ม"
