...
"เอมิขมวดคิ้วดูอารมณ์เสียกับเรื่องนั้น"

emi "อย่างคนในชมรมวิ่งงี้"

emi "แต่ก็ใช้ระบบสมัครใจน่ะนะ ไม่แปลกใจเท่าไหร่หรอก"
...
"ฉันคอยวิ่งไปเรื่อย ๆ ด้วยจังหวะสม่ำเสมอ ซึ่งก็ต้องทำอย่างนี้อยู่แล้ว"
...
"เอมิหัวเราะ ซ้ำยังไม่ลดฝีเท้าเธอลงเลยแล้วเพิ่มความเร็วอีก"
...
"เอมิพยักหน้ากับตัวเองเหมือนตัดสินใจบางอย่างได้"
...
"เอาจริง ๆ ก็แอบอายกับความอ่อนแอของตัวเองเหมือนกัน"
...
"สาวน้อย? เอาเถอะ คุณพยาบาลจิบกาแฟอย่างใจเย็น แต่ก็วางลงหลังมองตามสายตาของเอมิมาเจอเข้ากับฉัน\nที่ยืนทะมึนอยู่ตรงประตู" 
...
emi "พอดีพวกเราวิ่งด้วยกันอยู่แล้วเขาก็สะดุดล้มมือกุมอยู่ที่หน้าอกค่ะทีแรกหนูตั้งใจว่าจะมาเรียกคุณพยาบาลแล้วให้เขา\nรอก่อนแต่เขาก็บอกว่าไม่เป็นไรแล้วหนูก็คิดได้ว่ายังไงก็ไปหาคุณพยาบาลดีกว่าแล้ว—{w=1.5}{nw}"
...
"เอมิทำท่ากระมิดกระเมี้ยนดูสำนึกผิดอย่างน่ารัก"
...
"สุดท้ายเอมิก็ไม่กล้าพูดออกมาแล้วได้แต่พยักหน้า"
...
"คุณพยาบาลมองเพดาน คงสวดขอขันติจากพระเจ้าหรืออะไรสักอย่างแล้วมองกลับมาที่พวกเราสองคน"

nk "โอเค สรุปโง่{b}แพ็กคู่{/b}"

nk "ก็ค่อยยังชั่วหน่อยละมั้ง"

nk "เอ้า ฮิซาโอะ ขอตรวจดูให้แน่ใจหน่อยว่าหัวใจเธอจะไม่ระเบิดหรืออะไรไปก่อน"
...
"ฉันตามคุณพยาบาลอย่างว่าง่ายไปที่ห้องข้าง ๆ เพื่อดูว่าฉันจะไม่ได้ล้มพับแล้วตายไปจริง ๆ "
...
"เอมิดูหงอยและรู้สึกผิดมาก แม้แต่คำตอบของฉันก็ไม่ได้ช่วยให้เธอร่าเริงขึ้น"
...
"คุณพยาบาบเปิดหน้าต่างห้องทำงานของตัวเอง และข้างนอกมีลมพัด"

"ผ้าม่านสีขาวสะอาดโบกพลิ้วไปกับสายลมอย่างเอื่อยเฉื่อยเหนื่อยหน่ายคล้ายลูกคลื่น แสงลอดผ่านเข้ามาช้า ๆ\nครึ่งหนึ่งถูกผ้าม่านซับไป"
...
"ให้ตายเถอะ มาได้ไม่ถึงอาทิตย์ก็อยู่ในสภาพนี้อีกแล้ว รอบนี้ทำพลาดจริง ๆ ไม่น่าไปทำหล่อเป็นนักกีฬา\nต่อหน้าของจริงอย่างนั้นเลย"
...
"ฉันรูดผ้าม่านเก็บกลับไปหรี่ตามองแสงที่สาดจ้าเข้ามาจากทางหน้าต่าง สัมผัสของพื้นที่รับรู้ด้วยเท้าต่างกับที่ลมพัดเมื่อครู่\nลิบลับ"

"คุณพยาบาลผละจากงานที่ทำอยู่มามองโดยยังนั่งที่เดิม"
...
"ไม่น่าหวังดีเล้ย ฉันเงียบไปเพราะอายตัวเอง ส่วนคุณพยาบาลก็ง่วนอยู่กับการเตรียมอุปกรณ์ที่ดูเก่ากับแขนฉัน\nผ่านไปสองสามนาทีเขาก็เก็บ ไม่ได้ดูดีใจหรืออารมณ์เสีย"
...
"ฉันเก็บคำเถียงที่จะตอบกลับไป ที่คุณพยาบาลบอกก็เคยคิดเองอยู่ แต่พอได้ยินคนอื่นพูดแล้วก็อยากจะต่อต้าน"
...
"คุณพยาบาลพยักหน้าด้วยสีหน้าเรียบ ๆ เหมือนเมื่อครู่"

"ถ้าบอกว่า “บอกแล้ว เห็นไหม” สำทับอีกฉันก็คงโกรธ แต่เขาก็ไม่ได้พูด"
...
"แต่สิ่งที่ฉันทำจริง ๆ นั้น… คือการปล่อยให้ตัวเองลืมถึงปัญหาที่มีอยู่ การได้มาอยู่ที่นี่คือเครื่องเตือนถึงความเป็นจริง\nและยิ่งฝืนต่อต้านไปก็เจ็บปวด"
...
"เคนจิหายตัวเข้าไปในห้องราวนินจาพร้อมกับเสียงนั้น เขาปิดประตูดังปึงขณะที่ชิซูเนะและมิช่ากำลังเดินมา\nคนที่เดินนำนั้นเดินตรงเข้ามาหาฉัน ส่วนคนตามเดินเล่นเลาะไปตามกำแพง"
...
"ชิซูเนะชนนิ้วเข้าด้วยกันราวใช้ความคิดชั่งใจว่าถ้าตามซักไซ้ฉันต่อแล้วจะคุ้มกับความหยาบคายที่ทำให้ฉันรำคาญหรือไม่"
...
"ทั้งสองคนยิ้มกว้างให้ ฉันทั้งรู้สึกทึ่งทั้งรู้สึกว่าตัวเองงี่เง่าที่ทำตัวอย่างนั้น"

"สองคนนั้นก็ไม่ได้โง่สักหน่อย คงพอจะเดาได้แหละว่าฉันเป็นอะไร แถม…"

"เป็นคำง่าย ๆ ที่แสนอ่อนโยน รู้สึกโล่งใจที่ไม่ได้มองฉันไม่ดีแม้จะเป็นเช่นนี้ แม้ฉันจะไม่เหมือนคนอื่นที่นี่\nแม้ฉันจะทำตัวให้ชินไม่ได้"

"เบื้องหลังความซื่อบื้อและซุกซนเหล่านั้นแล้วเธอทั้งสองคนก็เป็นคนที่ใจดีและแสนดี ฉันคิดเช่นนั้น"

hi "ขอบใจ"

hi "สรุปคือเพราะฉันเป็นพวกกับเธอแล้ว วันนี้เลยจะให้ไปช่วยใช่มั้ย"
...
"จะว่าพวกเธอที่เป็นอย่างนี้ก็ว่าไม่ได้ มิช่าก็แค่พูดแทนชิซูเนะ ส่วนชิซูเนะก็เป็นคนอยากรู้อยากเห็นอยู่แล้ว\nแต่ก็อยากให้สองคนนี้เลิกตื๊อแล้วรู้ตัวที่จะสื่อสักที แต่มิช่าก็จะไม่เข้าใจ ส่วนชิซูเนะก็ไม่มีทางที่จะรับรู้ได้"
...
"ครูดูจะยังงงงันเล็กน้อยที่ฉันเข้าห้องสายคล้ายว่าฉันไปขัดจังหวะ"

"ซึ่งพอนึกถึงที่ครูชอบพูดยืดยาวเวลาสอนแล้วก็คงเป็นอย่างนั้น"

"ฉันยื่นกระดาษที่ได้มาจากคุณพยาบาลให้ ครูพยักหน้ารับไปแล้วกวาดตาอ่าน"

show muto normal
with charachange

"ครูยักคิ้วแล้วมองฉันด้วยสีหน้าเคร่งเครียดแต่ไม่พูดอะไร เพียงพยักหน้าให้อย่างหนักแน่น"

"ฉันยักไหล่แล้วกลับไปนั่งที่ตามที่ครูบุ้ยใบ้ให้ไป"
...
menu:
    ...
    mi "หน้าที่ของนายในฐานะสภานักเรียนคือการบอกว่าทำไมนายถึงโดดเรียนนะ! โดยเฉพาะถ้าเป็นเรื่องที่สนุกสนุ๊กสนุกน่ะ~!"
...
"ฉันปล่อยให้เธอสำนึกกับการกระทำของตัวเองสักพักแล้วตอบ ซึ่งอาจจะส่งไปไม่ถึงชิซูเนะด้วย แต่ช่างมัน"
...
"ครูมุโต้คุยเรื่อยเปื่อยถึงงานเทศกาลที่จะมาถึงในอีกสองวันนี้แล้วเลิกชั้น"
...
"น้ำเสียงของมิช่าดูงอนและหงอยไป"
...
mi "อีกอย่าง นายต้องมาชดเชยฐานที่นายไม่ได้มาช่วยงานเราเช้านี้ด้วย~!"

"คนอื่นในห้องเริ่มหันมอง คงเพราะมิช่าโน้มตัวข้ามโต๊ะมาจนหัวจะชนกับฉันอยู่แล้ว ผมม้วนของเธอระกับคอของฉัน"
...
"โชคดีที่ตอนนี้ครูมุโต้ยังไม่รู้ตัว หรือไม่ก็จงใจเมินมิช่า"
...
"ใช่แล้ว ฉันต้องจัดลำดับความสำคัญใหม่ ตั้งแต่ที่คุณพยาบาลคุยกับฉันเมื่อเช้าก็คิดมาตลอด ฉันจะทำเหมือนว่าฉัน\nยังสบายดีไม่เป็นโรคนี้ไม่ได้"

"ฉันนึกแปลกใจที่คิดได้เป็นเรื่องเป็นราวขนาดนี้ แต่ตอนนี้ก็ปล่อยตัวตามน้ำไปก่อน"

hi "ฉันสัญญาว่าเดี๋ยวจะแจงรายละเอียดให้ฟังทีหลัง แต่ไม่ใช่ตอนนี้ นะ? ฝากบอกชิซูเนะด้วยว่าขอโทษที่ปฏิเสธ"
...
"โชคดีที่มิช่าเข้าใจว่าฉันจริงจัง ครั้งนี้ลงตัวที่ฉันบอกอะไรให้ชัดเจนได้พอดีจนแม้แต่เธอยังเข้าใจ มิช่าล่าถอยกลับไป\nแล้วแปลที่คุยกันเมื่อกี้ให้ชิซูเนะ"
...
"ครูมุโต้เลิกคาบที่ตัวเองกำลังสอนเรื่องไฟฟ้าอยู่ให้เร็วกว่าปกติ แต่ก็พูดเรื่องงานโรงเรียนต่อทันที"
...
mu "ขอให้สนุก แต่เมื่อถึงวันอาทิตย์แล้วก็ขออย่าลืมความหมายของงานเทศกาลนี้…"
...
"ส่วนที่เหลือของประโยคถูกเสียงระฆังพักเที่ยงกลบ ทุกคนก็เริ่มเก็บข้าวของกัน"

"ครูมุโต้ใช้ความคิดอยู่พักหนึ่ง แต่เมื่อไม่มีใครสนใจแล้วจึงยอมแพ้และนั่งลง"
...
hi "คงเหลืองานไม่เยอะแล้วสิเนี่ย ไม่เห็นมีใครมีอะไรเลย"
...
"กระบวนการอะไรพวกนี้เป็นเรื่องที่ฉันไม่เข้าใจเลยจริง ๆ"
...
"ชิซูเนะวางตะเกียบลงแล้วทำภาษามือสั้น ๆ ให้มิช่าที่เหมือนกำลังกลืนชิ้นไก่ทอดด้วยความยากลำบากให้พูดแปลให้"
...
"เป็นเหตุผลที่คิดแล้วหดหู่จริง ๆ"
...
"สีหน้าของเอมิดูตลกจนฉันแทบหลุดขำ"

"เอมิหัวเราะคิกคัก ไม่รู้หัวเราะกับตัวเองหรือเรื่องอื่นกันแน่ หรือไม่ก็ขำลอย ๆ เป็นเสียงหัวเราะที่ฉันชอบ"
...
"เอมิกลั้นขำน้อย ๆ แล้ววางข้าวกล่องตรงหน้ารินและยื่นอีกกล่องให้ฉัน"
...
emi "ฉันก็เลยเคยคอยช่วยแต่งตัวอะไรให้รินตอนเช้า ก็ประมาณนั้น!"
...
"ขณะเอมิง่วนกับการเก็บกวาดส่วนของตัวเองรินก็พูดขึ้นมา"
...
"รินเป็นคนที่ดูจะไม่รู้สึกตัวเลยว่าเธอนั้นไม่มีแขน"

"แต่รินจะจงใจคิดอย่างนั้นหรือไม่ก็อีกเรื่องหนึ่ง"
...
"ฉันเดินไปทางด้านหลังของห้องสมุดตามบริเวณที่เป็นนวนิยายพลางปรายตามองหาอะไรที่เด่น ๆ"
...
"…ทว่าพบฮานาโกะที่นั่งอ่านหนังสือที่ดูหนาอยู่ตรงนั้น ฉันไม่คิดจะเข้าไปรบกวนเธอแบบคราวที่แล้วจึงกลับไปหาอะไรอ่านต่อ"
...
"ลิลลี่นึกเสียงอยู่ครู่หนึ่งพลางหันหน้ามาทางฉันที่เป็นต้นเสียง"
...
"ลิลลี่ดูจะจำเสียงคนได้ดี แต่แค่รู้ว่าเธอจำฉันได้ก็แอบปลื้มแล้ว"
...
li "ขอบใจจ้ะ ปกติฮานาโกะก็เป็นอย่างนั้นแหละ"
...
li "จ้ะ ปกติฮานาโกะไม่ชอบคนหมู่มากน่ะ ถ้าได้อ่านหนังสืออยู่คนเดียวแล้วจะรู้สึกโล่งขึ้นมาหน่อย"

"ลิลลี่อาจจะไม่ได้จงใจพูดเรื่องนี้ แต่ฉันก็อดทำหน้าเจื่อนไม่ได้เมื่อนึกถึงตอนที่เจอฮานาโกะครั้งแรก"

show lilly cane_smileclosed_ss
with charachange

"ฉันเงียบไปเพราะไม่อยากยกเรื่องนั้นมาคุยอีกแล้วเดินไปกับลิลลี่ตามถนนอันเงียบงัน"
...
li "ขอให้อะไร ๆ ลงตัวสักทีนะ เธอดันมาช่วงที่ทุกคนกำลังชุลมุนหัวหมุนเรื่องงานเทศกาลอยู่พอดี"

"ฉันนึกลังเลอยู่ครู่หนึ่ง แต่พอเห็นว่าลิลลี่เป็นคนเปิดกว้างฉันจึงออกความคิดเห็นไปตรง ๆ "
...
"ลิลลี่พยักหน้าเป็นเชิงรับรู้ดูจะพอใจกับคำตอบของฉัน รู้สึกเหมือนเธอมองฉันเป็นคนหนึ่งที่เธอคอยดูแล ไม่ต่างจาก\nที่เธอดูแลฮานาโกะและคนในห้อง 3-2"
...
"ระหว่างที่เดินไปตามถนนลิลลี่ก็ดูกระอักกระอ่วนขึ้นมา เธอตั้งสติแล้วพูดเรื่องอื่นออกมาก่อนที่ฉันทันจะได้ถาม\nว่าเธอคิดอะไรอยู่"
...
"เราเดินไปที่ร้านด้วยกัน ฉันชะลอฝีเท้าลงให้เท่ากับลิลลี่ ถ้าเทียบกับปกติที่ฉันเดินแล้วเธอจะเดินช้ากว่านิดหน่อย\nซึ่งก็แหงอยู่แล้วอะนะ"
...
"ฉันคิดอยู่สักพักกว่าจะเข้าใจสิ่งที่ลิลลี่จะสื่อ"
...
"ลิลลี่วางตะกร้าลงกับพื้นแล้วหย่อนกระเป๋านักเรียนลงไป จากนั้นก็หดไม้เท้าลงแล้วสอดไว้ที่มือจับตะกร้า\nก่อนจะใช้มือขวายกขึ้นมา"
...
"ก่อนฉันจะทันได้คิดอะไรต่อ ลิลลี่ก็เดินมาข้างฉันแล้วใช้นิ้วเรียวนั้นกระตุกแขนเสื้อ"
...
"คงเหมือนกับที่ลิลลี่มาซื้อของกับฮานาโกะทุกวันศุกร์ละมั้งนะ"
...
"พอลิลลี่จัดแจงตัวเองเสร็จก็ยืดเส้นยืดสายเล็กน้อยแล้วคว้าถุงของเธอไป ส่วนฉันก็หิ้วถุงของฉันที่มีสองใบ"
...
hi "น่า ชิซูเนะก็แค่อยากให้อะไร ๆ มันเรียบร้อยแหละ ทำไว้แต่เนิ่น ๆ ย่อมดีอยู่แล้ว ใช่มั้ยล่ะ"
...
"ลิลลี่เงยหน้าขึ้นเหมือนให้ตัวเองจดจ่ออยู่กับประสาทการฟัง ฉันคงต้องบอกว่าเกิดอะไรขึ้นสินะ"

hi "ริน… เทซูกะน่ะ น่าจะนามสกุลนั้นนะ เรียนที่โรงเรียนเดียวกันกับเราน่ะ"

show lilly cane_weaksmile_ni
with charachange

"ลิลลี่ทำหน้าเคร่งเมื่อได้ยินชื่อพลางทำสีหน้าปั้นยาก เหมือนเป็นส่วนผสมของรอยยิ้มสงบกับหน้าเหยเวลาเจ็บ"
...
"แต่ท่าทีที่แสดงให้เห็นว่ารินรับรู้บางอย่างเริ่มปรากฏในแววตาสีเข้มของเธอว่าเธอต้องตอบสนอง"
...
"รินหันหน้าไปทางขวาให้เห็นว่าคนที่ว่านั้นเดินไปทางไหนราวกับว่าเป็นประเด็นสำคัญแล้วหันกลับมา ท่าทางคล้ายหุ่น\nที่ตั้งอยู่ในนาฬิกาเรือนใหญ่ ๆ ที่มีกลไกอยู่ซับซ้อน"

"ทั้งที่รินดูเหมือนจะเป็นคนเงียบ ๆ แต่เธอกลับใช้คำได้ยืดเยื้อฟุ่มเฟือยเอามาก ๆ "

"ฉันยังเงียบรอเพราะไม่แน่ใจว่ารินพูดจบหรือยัง ลิลลี่ก็เงียบดูไม่รู้จะพูดอะไรต่อเหมือนกัน"

"พวกเราคงกลัวว่าถ้าตอบอะไรไปคงเป็นการกระตุ้นให้รินพูดต่ออีก"
...
"รินขมวดคิ้วดูเครียดหนักกับทั้งคำถามของฉัน บทสนทนานี้ และคำตอบที่ตัวเองจะพูด"
...
"ได้คำยืนยันที่ไม่รู้ว่าเชื่อได้จริงหรือเปล่ามาจากปากรินแล้ว… ทีนี้ยังไงต่อดี"

"จะทิ้งรินไว้ข้างหลังเลยก็ได้แหละ หลังใครก็ช่างเถอะ… แต่ตอนนี้ก็ค่ำแล้ว แถมถ้ามีคนมาเจอรินยืนอยู่ตรงนี้\nตอนกลางค่ำกลางคืน เสียงที่จะมาหาพวกเราคงไม่ใช่คำชมแน่ ๆ "

"ซึ่งก็ดูจะเป็นอย่างที่ว่าแน่ ๆ เว้นเสียแต่ว่ารินจะนึกออกว่ามาทำอะไรที่นี่"

"แต่ถ้าจะให้เดาว่าคิดอะไรอยู่ถึงออกตะลอนมาถึงนี่ โอกาสถูกคงพอ ๆ กับถูกหวย"
...
"รินเบิกตาแล้วสะดุ้งโหยงดูปลอม ๆ เหมือนซ้อมมาเพื่ออะไรอย่างนี้โดยเฉพาะ"
...
"ลิลลี่แทรกขึ้นมาจังหวะที่ฉันกำลังจะปฏิเสธข้อกล่าวหาที่ว่าฉันอ่านใจได้นั้นต่อด้วยน้ำเสียงดูเป็นกังวล\nรอยยิ้มอันบางเฉียบของเธอไม่ได้ช่วยปกปิดความเป็นห่วงนั้นเลย"
...
menu:
    ...
    "ไม่ค่อยอยากคุยเรื่องนี้เท่าไหร่เลย":
        return m2
...
"หน้าผากลิลลี่ย่นด้วยความเป็นกังวล ฉันไม่อยากให้เธอต้องมาคิดมากอย่างนั้นกับฉันเลย เพิ่งรู้จักกันนี่นะ"

hi "อื้ม นั่นแหละ สงสัยที่แบบนี้คงหายากละมั้ง แต่ก็อยากรู้อยู่ดีว่าคิดอะไรอยู่"

"น้ำเสียงฉันนิ่งเกินไป แม้แต่ฉันยังรู้สึกว่าฟังแล้วแปร่งหู แถมยังพูดรัวอีกต่างหาก ฉันนึกสงสัยแวบหนึ่งว่าลิลลี่\nจะจับสังเกตอะไรได้มากแค่ไหนด้วยการฟังแค่เสียง"
...
"ลิลลี่ตัดบทตัวเองกลางคัน อาจจะคิดว่าสอดรู้มากเกินไป แต่นับว่ารู้สึกตัวไวทีเดียว และถึงแม้ฉันจะไม่อยากพูดเท่าไหร่\nแต่ก็ไม่ควรโกหกไปอยู่ดี"
...
hi "คราวที่แล้วก็หัวใจวายเพราะโรคนี้นี่แหละ แล้วนอนอยู่กับโรงพยาบาลช่วงฤดูใบไม้ผลิเสียนาน แล้วหมอ\nก็สั่งให้มาเรียนที่โรงเรียนยามากุ"

"ลิลลี่พยักหน้าเงียบ ๆ เป็นเชิงรับรู้"

"ทว่าคำตอบของฉันยิ่งทำให้เธอขมวดคิ้วหนัก ลิลลี่ดูทำตัวไม่ถูกว่าจะรับมือยังไง เพราะพวกเราก็ไม่ได้สนิทกัน\nขนาดนั้น"

"แต่จะว่าก็ไม่ได้หรอก เป็นฉันก็คงรู้สึกแบบนั้นเหมือนกัน"


label th_A30c:

"ฉันนึกแปลกใจที่ไม่นานลิลลี่ก็ทำหน้าเหมือนนึกบางอย่างขึ้นได้"
...
"ฉันทำหน้าเบ้เล็กน้อย ลิลลี่เป็นคนที่ปะติดปะต่ออะไรได้ดีเกินคาด"
...
"ถึงจะอยากคลายความกังวลลิลลี่ แต่ฉันก็ไม่อยากจมอยู่กับเรื่องนี้เหมือนกัน"
...
"รินยืนมองภาพเขียนด้วยสีหน้าที่อับอายที่สุดเท่าที่เธอทำได้"
...
"แน่นอนว่าพวกเราไม่ได้อยากทำให้รินต้องย่ำแย่ไปกว่าที่เธอเป็นอยู่แล้ว"

"ในใจรู้สึกปั่นป่วนไปหมด รินนี่ทำให้คนเป็นห่วงได้เก่งจริง ๆ "

"รินเป็นคนที่ไม่ควรถูกทิ้งให้อยู่ตัวคนเดียวเลย"
...
"ลิลลี่เอียงคอเล็กน้อยแล้วเฟ้นหาคำที่สุภาพที่จะใช้เรียกรินว่าเพี้ยนโดยไม่ต้องใช้คำว่าเพี้ยน"
...
"ลิลลี่หัวเราะน้อย ๆ ฟังดูไพเราะพลางพยักหน้าเออออ"
...
"ลิลลี่ส่งยิ้มหวานให้ฉัน ซึ่งดูแปลกตาแม้จะเห็นเธอยิ้มอยู่บ่อย ๆ ก็ตาม"
