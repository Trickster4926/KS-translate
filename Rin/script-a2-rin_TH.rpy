...
"จู่ ๆ ประตูก็เปิดออกเสียงดังปัง ครูมุโต้งึมงำเป็นคำทักทายยามเช้าอยู่ที่โถงทางเดิน"
...
"สภาพครูเหมือนไม่ได้นอนมาเลยแม้แต่น้อย"
...
"ทั้งห้องร้องตอบเสียงต่างกันไป จากนั้นครูก็ขานชื่อแล้วเริ่มสอน"
...
"ไม่นานฉันก็ตกอยู่ในสภาพสะลึมสะลือไม่ต่างไปจากคนอื่น ๆ ในห้อง ปล่อยให้สิ่งที่ครูพล่ามนั้นลอยเข้าหูซ้ายปลิวออก\nทะลุหูขวาไป"
...
"ฉันตอบไปหลังถูกเลือกต้อนให้ตอบอย่างไม่ยุติธรรม จากนั้นครูก็ยิ้ม เป็นรอยยิ้มเป็นมิตรที่ถ้าเด็กเล็กได้เห็นแล้วคง\nช็อกจนเป็นลมล้มพับไป"
...
"เท่าที่เห็น ครูมุโต้จะมีปัญหากับการจำชื่อคนในห้องเอามาก ๆ แล้วเกินครึ่งก็อยู่มาแล้วตั้งแต่สมัย ม. 4"
...
"เอมิชนเข้ากับฉัน แต่อย่างน้อยคราวนี้ก็เฉี่ยวแขนฉันไปเท่านั้น"
...
"เอมิร้องหงิงเหมือนลูกหมาเจ็บ พอได้เห็นก็ทำเอารู้สึกผิดทันทีที่พูดกระแนะกระแหนไปอย่างนั้น"
...
hi "ก็ไม่ที่ไหนละมั้ง ไม่อยากอยู่ตัวคนเดียวในห้องกับครูมุโต้ด้วย เหมือนจะเมาค้างมั้ง"
...
"เอมิมองด้วยสายตาไม่อยากเชื่อ ราวกับว่าบ้าไปแล้วที่พูดอย่างนั้น"
...
"พูดงี้ทุกรายแหละ พอคำสัญญาที่ไม่ค่อยน่าไว้ใจนั้นออกจากปากแล้วเอมิก็เริ่มวิ่งเหยาะ ๆ ไปตามบันได"
...
"ฉันถอนหายใจเบา ๆ แล้วเดินตามทางที่เอมิออกไป เพียงแต่ไม่ได้เดินลงบันไดอย่างเธอ"
...
"รินลากเสียงยืดยาวฟังดูง่วงงุน แต่เธอกลับลืมตากว้าง"
...
"รินถามหาความสมเหตุสมผลจากคำถามของฉันที่ไม่ได้ผิดอะไรเลยโดยไม่แม้จะเอียงคอมามอง"
...
"รินยักไหล่เนือย ๆ แล้วทำเสียงฟุดฟิดไม่สนใจ"
...
"รินละสายตาจากท้องฟ้าแล้วมองตรงมาที่ฉันสักที ความลึกล้ำในสายตาอันพุ่งตรงยามเธอจับจ้องอะไรบางอย่างนั้น\nชวนให้ตกใจ"
...
"ฉันแหงนหน้ามองไปยังที่ที่รินมองอยู่"
...
"เอมิโน้มตัวแล้วมองฉันยืนบังเงาตรงหน้าฉันเหมือนที่ฉันยืนบังเงาหน้ารินก่อนหน้านี้เป๊ะ"
...
"เอมิปัด ๆ ฝุ่นออกแล้วอ้อมฉันไปอย่างพลิ้วไหวและนั่งลงข้าง ๆ ริน"
...
"เอมิขมวดคิ้วแต่ก็ไม่ได้ซักไซ้อะไรต่อ ซึ่งก็ดีแล้ว"

"เอมิดูเป็นคนค่อนข้างรั้น ถ้าเธอจะมาตามตื๊อเรื่องนี้กับฉันทุกวันก็คงไม่ไหว แค่ภาระจากชิซูเนะกับมิช่าก็เกินพอแล้ว"
...
"แววตามิช่าบ่งบอกว่าไม่ใช่แค่ถามเปล่า แต่ฉันก็ไม่รู้อยู่ดีว่าทำไมถึงถามน่ะนะ"
...
"แล้วฉันก็ไม่ได้ตอบ มิช่าก็ปล่อยฉันไปเพราะชิซูเนะต้องการความสนใจจากเธออยู่"
...
"ครูโนมิยะย่างสามขุมมาที่โต๊ะของตัวเองแล้วยิ้มทักทายอย่างเล่นใหญ่"
...
"ไม่มีคำตอบอื่นนอกจากเสียงงึมงำพึมพำที่จับใจความไม่ได้ ซึ่งเหมือนครูโนมิยะจะนับไปว่าเป็นเสียงตกลงโดยเอกฉันท์"
...
"รินนั่งอยู่ที่มุมหนึ่งของห้องไกล ๆ ยังเหม่อมองไปทางหน้าต่างดูไม่สนใจจะทำกิจกรรมด้วย"
...
"ฉันเรียกริน แต่ก็ไม่มีเสียงตอบรับ"
...
"รินดูจะตอบสนองกับตัวตนของฉันแล้ว หันหัวมาดูว่าใครเรียกเหมือนหุ่นยนต์"
...
"พอมาเห็นอุปกรณ์ที่ครูโนมิยะเตรียมไว้ให้สำหรับกิจกรรมวันนี้แล้วก็เป็นต้องงง เพราะเหมือนจะได้วาดภาพร่าง\nโดยใช้หมึกแทนที่จะเป็นแร่แกรไฟต์หรือดินสอ"
...
"ฉันคว้าเก้าอี้แถวนั้นที่ว่างอยู่มานั่งลงตรงหน้าริน"
...
"รินเอียงคอแล้วเลิกคิ้วขึ้นด้วยความสงสัยราวไม่เข้าใจว่าทำไมฉันถึงไม่เข้าใจที่เธอถาม"
...
"รินพยักหน้าตกลงแล้วลุกขึ้นและสะบัดรองเท้าแตะออก"
...
"ถึงจะเคยเห็นรินใช้เท้าทำอะไร ๆ มาแล้วตั้งแต่การกินยันการวาดรูป แต่ความคล่องแคล่วที่ได้เห็นนี้ช่างน่าทึ่งจนได้แต่\nมองตาค้าง"
...
"สายตาของรินนั้นแหลมคมทว่าไร้ซึ่งอารมณ์ ราวกับว่ารินกำลังจะดูดกลืนส่วนหนึ่งของฉันเข้าไปในตัวของเธอเอง\nฉันรู้สึกเหมือนตัวเองหดเล็กลงด้วยแรงกดดันจากสายตาของเธอ"
...
"รินร่างภาพด้วยความมั่นใจโดยใช้ฝีแปรงอันหนักแน่นของพู่กันอันอ่อนโยนโดยไม่สนใจเลยว่าหากลากผิดแล้ว\nจะเกิดความเสียหายอะไรขึ้นมาบ้าง"
...
"คราวนี้รินไม่มองมาที่ฉันแต่มองไปรอบ ๆ ห้องแทน โล่งไป จ้องคนที่ไม่ได้จ้องกลับนี่สบายใจกว่าเยอะ"
...
"รินอยู่นิ่ง ๆ ได้ไม่เคยถึงสิบวินาที เอียงคอซ้ายทีขวาทีเพื่อดูภาพวาดของเธอพลางกัดริมฝีปากดูไม่พอใจ แล้วยัง\nยุกยิกไปมาเหมือนยืนอยู่บนถ่านร้อน ๆ"
...
"ครูโนมิยะเดินผ่านแล้วทักเรื่องภาพร่างที่พวกเรากำลังเริ่มทำกันอยู่"
...
"บางครั้งบางทีรินก็เอนตัวเหมือนจะหามุมมองบางอย่าง บางทีก็โน้มตัวจนจมูกแทบแตะกระดาษ"
...
"รินยังไม่ละสายตาจากภาพวาด ซึ่งดีแล้ว เสียงที่ทำลายความเงียบนี้ทำฉันสะดุ้งโหยงราวกับโดนไฟช็อต"
...
"ฉันไม่ได้ยินว่ารินตอบว่าอะไร เพราะจู่ ๆ เธอก็หันไปพูดกระซิบกระซาบกับภาพวาดตัวเองเป็นการส่วนตัว"

"ฉันไม่เข้าใจว่าทำไมถึงวาดเก่งขนาดนี้ทั้งที่เธอสมาธิสั้นพอ ๆ กับผีเสื้อ"

"เหมือนว่ารินหมดความสนใจแล้วฉันจึงหันมาทำส่วนของตัวเองต่อ"
...
"ฉันนึกสงสัยว่าที่บอกไปนั้นคือเอาใจรินหรือสนุกจริง ๆ ฉันไม่แน่ใจว่าเป็นอย่างไหน"
...
"รินแอบเข้ามาทางด้านหลังฉันระหว่างที่ฉันเหม่อคิดไปเรื่อยอยู่"
...
"คำพูดเรียบ ๆ ของรินทำให้ฉันรู้สึกตัวขึ้นมาในทันทีอย่างเหลือเชื่อ อยากส่องกระจกเสียมันตอนนี้เพื่อที่จะได้ยืนยัน\nหรือโต้แย้งคำพูดของรินไป เป็นความรู้สึกที่ไม่ดีเลย"

"อาจจะมีแค่รินที่คิดอย่างนั้น หวังว่าจะมีแค่เธอนะ หวังว่าคงไม่มีใครเห็นฉันเป็นเหมือนอย่างรูปนั้นนะ"
...
"อยากหาคำอะไรแสบ ๆ มาย้อนเหลือเกิน แต่ครูโนมิยะก็รีบรัดให้ออกห้องไปไม่ให้เวลาได้คิด"
...
"ฉันนึกแปลกใจที่รินไม่อยู่ที่โถงทางเดิน เพิ่งผ่านไปไม่กี่วินาทีหายไปไหนแล้ว ได้คุยต่ออีกหน่อยคงดี"
...
"เสียงเคนจิตอบมาจากอีกฟากประตู ถึงจะฟังไม่รู้เรื่องก็เถอะ พอจะลองเปิดประตูดูก็เห็นว่าล็อก"

show kenji neutral at Slide(0.2,0.5,0.3,0.5,1.0)
with charaenter

"ผ่านไปหลายวินาทีเคนจิก็ปลดล็อกแล้วเปิดประตู"
...
"เคนจิขยิบตาถี่ผิดปกติพลางขมวดคิ้วด้วยความร้อนรน"
...
"แทนที่จะให้ฉันเข้าห้องไป เคนจิผละตัวออกแล้วปิดประตู"

show kenji neutral at Slide(0.2,0.5,0.3,0.5,1.0)
with charachange

"ผ่านไปชั่วอึดใจเคนจิก็กลับมาพร้อมกองหนังสือหนา ๆ สามเล่มแล้วยื่นให้ฉัน"
...
"แน่นอนว่าฉันไม่อยากไปวิ่งให้เสี่ยงมีอาการอะไรอีก อีกอย่าง เอมิคงไม่รู้หรอก น่าจะถอดใจไม่ยอมตื๊อฉันแล้วด้วย"
...
"ต้องการอะไรจากฉันแน่ ๆ เห็นชิซูเนะยิ้มก็รู้ เป็นรอยยิ้มที่ช่างเจิดจ้าเสียจนเกินกว่าจะมาจากใจจริง\nและช่างได้จังหวะเกินกว่าจะมาแบบลอย ๆ"
...
"คำทักทายของมิช่าเต็มไปด้วยความสดใสและพลังงานเหลือล้น"
...
"ฉันสบตาเข้ากับชิซูเนะที่ทำหน้าจดจ่อแปลก ๆ แต่พอเธอเห็นว่ามองอยู่ก็ขมวดคิ้วแล้วเบือนหน้าหนี"

show shizu adjust_happy
with charachange

"แวบหนึ่งฉันคิดว่าชิซูเนะคงเห็นว่าฉันคิดมากเรื่องอะไรอยู่แล้วคิดอยู่ว่าจะตอบยังไงดี แต่แล้วเธอก็ดันแว่น\nพลางปรับสีหน้า"
...
"รินจะพูดอย่างนี้ หรือไม่ก็อะไรที่หลุดโลกพอ ๆ กัน แล้วฉันก็ต้องรับมือกับเรื่องไร้สาระอะไรก็ตามที่สมองของเธอ\nสุดจะสรรหามาได้ก่อนเข้าเรียนคาบที่เธอไม่ได้อยากเข้าเรียน"
...
"ฉันยืนงงงันประจันหน้ารินนานไปหน่อยจนเธอคิดว่าคงต้องพูดสิ่งที่ขอไปให้ชัดกว่านี้"
...
n "\n\nให้รินฟังเสียงหัวใจฉันไปเลยก็คงดี ใช่ว่าจะเป็นเรื่องใหญ่อะไร สุดท้ายก็ไม่ได้มีอะไรใหญ่ขนาดนั้นอยู่แล้ว"
...
"รินมองฉันแปลก ๆ แล้วเอียงหัวไปทางซ้ายเล็กน้อย แต่ก็ไม่ได้พูดอะไรต่อสักพัก"
...
n "\nฉันต้องถือเอาว่าที่รินพูดคือความจริง เธอไม่มีเหตุผลอะไรที่จะต้องโกหก"
...
"น้ำเสียงเอมิดูอ่อนหวานและนุ่มนวลเกินกว่าจะมาจากใจจริง ฉันสัมผัสได้ถึงกับดักที่พร้อมจะงับฉันที่ถูกวางไว้โดย\nปีศาจสุขภาพดีตนนี้"

"ไม่ต้องให้พูดต่อก็รู้เลยว่าจะบอกอะไร เพราะฉันเลี่ยงมาตลอดทั้งสัปดาห์"
...
"ฉันเรียกรินไปเหมือนนึกทิ้งทวน แต่หลังจากนั้นก็มาอายแล้วคิดว่าจะพูดอะไรออกไปทำไม"
...
"ยูโกะยิ้มหวาน ๆ แถมแกน ๆ อีกต่างหาก ฉันก็ยิ้มขอบคุณไปบ้าง"
...
n "สำหรับรินแล้วกีฬานั้นเป็นมากกว่างานอดิเรกหรือการแข่งขัน การวิ่งคือตัวตนของเธอ"
...
"รินหันมามองฉัน เป็นครั้งแรกที่ฉันเห็นแววตาสีหน้าอันเปล่ากลวงที่คงเป็นเอกลักษณ์เฉพาะเธอเป็นแน่แท้"
...
"กิจกรรมชมรมวันนี้ยังไม่เริ่มเพราะครูโนมิยะยังไม่มา ระหว่างนี้ฉันก็คอยเล่าความคิดฉันที่มีต่อยามากุให้รินฟัง"
...
"ฉันอยากจะไหลต่อ แต่ครูโนมิยะก็มาแล้ว"
...
"มีเสียงพึมพำงึมงำดังขึ้นมา แต่ไม่มีใครจะออกเสียงเห็นด้วยหรือคัดค้านครูโนมิยะ"
...
no "โอ้? เพื่อนคนใหม่ล่าสุดของเราดูท่าจะมีอะไรน่าสนใจละ พูดมาเลยหนุ่ม"
...
"ครูโนมิยะเหมือนจะคาดหวังให้ใครเดาก่อน แต่ในเมื่อไม่มีใครกล้าขัดการบรรยายอันเปี่ยมพลังครูก็พูดต่อ"
...
"ครูโนมิยะหยุดไปครู่หนึ่ง สายตากวาดมองผู้ฟังด้วยแววตาที่ฉายความคลั่งไคล้"
...
"ครูโนมิยะเอนตัวพิงกับโต๊ะแล้วกระแอมไอเตรียมการ"
...
"แต่จะว่าขนาดนั้นก็ไม่ได้ ครูโนมิยะเองก็กระตุ้นให้มีการถกประเด็นกันบ้างแล้ว แต่คนในชมรมดูจะไม่ค่อย\nอยากตอบกัน"
...
"จู่ ๆ ครูโนมิยะก็โผล่มาอยู่ข้างพวกเราด้วยท่าทีที่ยังดูร้อนแรงกับบทบรรยายที่เพิ่งเล่าไป"
...
"รินดูอึดอัดใจขึ้นมา ฉันไม่รู้ว่าทำไม เพราะสิ่งที่ครูโนมิยะพูดนั้นก็ฟังดูจะเป็นเรื่องที่ดีจริง ๆ"

"แต่เธอดูเครียดและสับสน ฉันไม่เคยเห็นรินเป็นอย่างนี้เลย"
...
"รินเงยหน้ามามองหน้าอันเปล่งประกายของคุณครูแล้วก้มมองโต๊ะตัวเอง"
...
"ในที่สุดครูโนมิยะก็ดูรู้สึกตกใจเล็กน้อยกับท่าทีที่ไม่สบอารมณ์มากนักของรินเสียที จากนั้นก็ยิ้มกว้างให้เธอ\nแล้วลูบหัวเบา ๆ"
...
"ฉันตามรินที่เพิ่งออกจากห้องมาก่อนหน้าไม่นาน พวกเราเดินไปตามบันไดไปยังชั้นหนึ่ง ระหว่างนั้นฉันก็คิดเรื่อง\nบทสาธยายอันเปี่ยมพลังของครูโนมิยะ ส่วนรินก็ดูครุ่นคิดบางอย่าง"

"ฉันรู้ว่าสภาพนี้ไม่ใช่อะไรที่แปลกสำหรับริน แต่สีหน้าของเธอทำให้ฉันอึดอัดชอบกล"
...
"รินไม่ตอบ แต่เท้าเธอชะงักกลางทางระหว่างที่กำลังเดินไปโถงใหญ่"
...
"รินหยุดยืนอยู่ตรงหน้าต้นเมเปิลต้นใหญ่ต้นหนึ่งที่อาจจะใช่หรือไม่ใช่ต้นทุกข์ ใบอันเขียวชอุ่มของมันพลิ้วไหว\nตามสายลมโชยที่พัดผ่านมาทางรอยแยกเล็ก ๆ ที่พวกเราแหวกเข้ามา"
...
"รินดูงง ๆ ซึ่งก็ว่าเธอไม่ได้หรอก เธอเอียงคอเล็กน้อยพลางกลับมาทำหน้าอย่างเดิม"
...
"รินไม่ตอบในทันทีคล้ายว่ายังลังเลอยู่ว่ารู้สึกยังไง หน้าตายของเธอค่อย ๆ เคร่งเครียดขึ้นระหว่างที่เธอกำลังโยกตัว\nไปมา"
...
"รินไม่พูดอะไรอยู่พักหนึ่งคอยจัดความคิดตัวเองอยู่เงียบ ๆ เสียงที่แทรกเข้ามาเป็นเสียงนกร้องที่อยู่สักที่บนต้นไม้\nตามด้วยเสียงกรอบแกรบของใบไม้จากนกที่บินออกไป"
...
"เหตุผลของรินฟังดูเหมือนข้ออ้างห่วย ๆ ฉันขมวดคิ้วอย่างที่ฉันทำประจำ แต่เธอก็ไม่ทันสังเกต"
...
"รินผลุบตัวลงนั่งกับพื้นป่าหลังพิงต้นไม้ที่เธอตั้งชื่อว่าต้นทุกข์ ฉันคิดอยู่ครู่หนึ่งว่าจะทำอะไรดีก่อนจะนั่งลงตาม\nห่างจากเธอไปประมาณหนึ่งเมตร"
...
"บางครั้งรินก็แหงนหน้าขึ้นจนเหมือนคอแทบหักมองแผ่นฟ้าที่ถูกร่มใบของต้นทุกข์บังจนเหลือเพียงผืนน้อย"

"บางครั้งรินก็จ้องตรงไปข้างหน้าราวกับมองบางอย่างที่ไกลเกินเธอเอื้อม เธอพึมพำอยู่กับตัวเองเสียงแผ่วเบา เบาเสียจน\nแม้แต่ฉันที่นั่งอยู่ข้างเธอนั้นยังไม่ได้ยิน"
...
"การตัดสินใจของรินนั้นแตกต่างทว่าเหมือนกัน"
...
n "แต่… พอได้เดินข้างรินแล้วก็รู้สึกดี ถึงจะไม่ได้มีอะไรไปมากกว่านั้นก็เถอะ"
...
n "รินดูเป็นคนไม่สนโลกมากมายหลายอย่าง แต่บางอย่างในตัวเธอทำให้ฉันฮึดขึ้นมากว่าปกติ"

nvl clear

n "\n\n\nไม่ใช่ว่าฉันอยากทำให้รินประทับใจหรืออะไร เพราะดูจากสภาพแล้วกว่าจะทำให้รินประทับใจได้ก็คงต้องทุ่มแรง\nปานยอดมนุษย์ แต่ฉันว่าที่จริงเป็นเพราะความรู้สึกหนึ่งในใจที่ไม่อยากทำให้รินผิดหวังมากกว่า"
...
n "ฉันอยากคุยกับรินให้มากกว่านี้"
...
"พอได้เห็นเคนจิมายืนสูดอากาศอยู่ข้างนอกแล้วก็รู้สึกประหลาด แต่อย่างน้อยตอนนี้ก็ค่ำแล้ว ฉันแอบคิดไปด้วยซ้ำ\nว่าถ้าเคนจิโดนแดดแล้วตัวเขาจะสลายเป็นผุยผง"
...
"ดูจากสีหน้าแล้วรู้เลยว่าไม่รู้จักไม่พอยังไม่เห็นหน้ารินทั้งที่อยู่ใกล้ขนาดนี้อีก"
...
"ฉันนับถือเคนจิขึ้นมาหน่อย ๆ แล้ว"
...
"เคนจิโน้มตัวเข้ามาใกล้แล้วกระซิบกระซาบรัวเร็ว เห็นหน้าเขากระตุกด้วย"
...
"เคนจิหันหน้าจากฉันไปหาริน แล้วฉันก็รู้สึกทันทีว่าต้องยั้งสุดชีวิตไม่ให้สองคนนี้คุยกันได้ แต่ตอนนี้ฉันก็ทำอะไรได้\nไม่มาก นอกเสียจากว่าจะฉันจะลงไม้ลงมือ"
...
"เคนจิมองล่อกแล่กเหมือนได้ยินอะไรบางอย่างแล้วจัดแจงเสื้อคลุมตัวเอง"
...
n "ฉันเห็นรินเดินเตาะแตะไปตรงสุดโถงทางเดินอยู่บ่อย ๆ ประตูบานนั้น ห้องนั้น กลิ่นสีและกระดาษ เหล่านั้นดูจะ\nมีความหมายต่อเธอมากกว่าส่วนที่เหลือของโลกทั้งใบรวมกันด้วยซ้ำ"

n "รินบอกว่าตัวเองได้รับอภิสิทธิ์ในการใช้ห้องนั้น ซึ่งฉันเชื่อสนิทใจ ครูโนมิยะคงไม่มีทางปฏิเสธอะไรรินแน่นอน"

n "ครูเอ็นดูเธออย่างลุงที่เอ็นดูหลานคนโปรด"

nvl clear

n "\n\n\nแต่คนโปรดที่ว่านั้นไม่ได้โปรดอะไรเลย รินบอกว่าตัวเองก็ขอบคุณที่คุณครูอุตส่าห์ทุ่มเทเพื่อเธอ แต่แม้ปากเธอจะพูด\nอย่างนั้น ทว่าสีหน้าของเธอยังคงเหมือนเก่า"

n "ราวกับว่าเธอพูดถึงหินก้อนหนึ่งที่ไม่ได้น่าจดจำอะไรที่เห็นเมื่อวันก่อน ฉันดูไม่ออกว่าความสัมพันธ์ของสองคนนั้น\nเป็นอย่างไหนกันแน่"

n "รินดูจะไม่ยอมให้ใครเข้าใกล้ ฉันว่าแม้แต่เอมิก็ยังก้าวข้ามระยะห่างที่กั้นตัวรินออกจากโลกทั้งใบนั้นไปไม่ได้"

n "\n\nไม่เข้าใจเลย รินดูไม่สนใจอะไร ทว่าก็ดูมีความคลั่งไคล้"
...
"รินขยับข้อเท้าที่คีบพู่กันไว้อย่างทะมัดทะแมงจุ่มสีชาดแล้วกดลงกับผืนผ้าใบเบา ๆ รอยสีแผ่ออกราวกับว่าพู่กันนั้น\nเลือดไหล"
...
n "\n\nชมรมศิลปะส่วนมากก็จะสบาย ๆ ปล่อยอิสระมาก ๆ ยกเว้นบางครั้งที่ครูโนมิยะจะตื่นเต้นอยากบรรยายเรื่องวิธี\nหรือแนวการวาดที่อยากเอามาสอน แต่นอกนั้นทุกคนจะทำอะไรที่ตัวเองสนใจก็ทำได้เต็มที่"
...
"เมื่อสาวสองคนนั้นออกห้องชมรมไปด้วยคำว่า “บ๊ายบาย” อันสดใสแล้วครูโนมิยะก็ลุกขึ้นยืน เสียงขยับเก้าอี้ดังเอี๊ยด\nของคุณครูทำลายความสงบเงียบยามบ่ายนี้"

"ครูจับตั้งกระดาษที่อยู่ในมือตอกกับโต๊ะสองครั้งให้เป็นระเบียบแล้วยืดตัว"
...
"ในห้องมีนักเรียนอยู่สองคน แต่จริง ๆ ก็คุยอยู่กับคนเดียวน่ะนะ ครูโนมิยะจะเอาเวลาว่างมาติวให้รินนอกเวลา\nกิจกรรมชมรมด้วย แล้วก็คงจะอยากคุยเรื่องแผนที่จะเอางานของรินไปจัดแสดงที่หอศิลป์อีกสักหน่อยนั่นแหละ"
...
"รินน่าจะยังอยู่วาดภาพต่อระหว่างที่รอคุณครู"
...
"อาจจะมีแค่ครูโนมิยะที่พูด ๆ ๆ อยู่คนเดียวเหมือนตอนทำกิจกรรมชมรมแล้วปล่อยให้รินซึมซับอะไรก็ตามที่ออกมา\nจากคลังความรู้ทางศิลปะที่ไร้สิ้นสุดของครู เหมือนอย่างที่ดอกทานตะวันหันหน้าเข้าหาดวงอาทิตย์"
...
"รินดูมุ่งมั่น ทว่าก็ดูผ่อนคลาย เธอสะบัดพู่กันไปมาอย่างไม่ลังเลเลย สีบรรจบและแยกจากกัน ผสมกลมกลืนซ้อนทับกัน\nอยู่บนผืนผ้าใบ สีเหล่านั้นแปรร่างไปตามเป้าหมายที่เงียบเชียบของเธอ"
...
"เท้าของรินชะงักอยู่บนผืนผ้าใบขณะที่รินจ้องภาพที่เธอวาดอยู่นิ่ง ๆ ราวกับว่ากำลังมองไปยังสุดขอบฟ้าไกล"
...
"และพอรินกะพริบตาสิ่งนั้นก็หายไป"
...
"รินใช้คำเดียวกันกับตอนที่ครูโนมิยะบรรยายเรื่องเนื้อแท้ของศิลปะ ตอนนั้นฉันนึกว่ารินไม่ได้ฟังอยู่ เธอฟังอยู่\nหรือเปล่านะหรือว่าเคยฟังบทบรรยายอันเปี่ยมพลังของครูมาก่อนหน้านี้แล้วกัน"
...
"รินเหล่มองมาทางฉันแวบหนึ่งก่อนจะกลับไปมองที่ภาพวาด แต่เธอไม่ได้คีบพู่กันแล้ว"
...
"และทันใดนั้นเองครูโนมิยะก็กลับมาหลังประชุมเสร็จ คุณครูโบกมือทักทายให้อย่างที่คนในละครน้ำเน่าทำกัน\nดูจะแปลกใจเล็กน้อยที่เห็นฉันอยู่กับลูกรัก ครูเดินขึงขังมาที่โต๊ะแล้ววางกระดาษลง"

"ครูโนมิยะหยิบผ้าเช็ดหน้าขึ้นมาแล้วบรรจงเช็ดแว่นเป็นอย่างดีก่อนจะเดินมาหาพวกเรา"

"ก่อนที่ครูจะทันได้เดินเข้ามาใกล้พอได้ยินอะไร รินพูดสั้น ๆ เสียงค่อยกับฉัน"
...
"ครูยิ้มอายน้อย ๆ แล้วมองเราสองคนด้วยความอยากรู้เต็มสูบ"
...
"ฉันกดดันรินไปนิดหน่อยเผื่อเธอจะตัดสินใจอะไรได้สักที แต่ครูโนมิยะก็เข้ามาขวาง"
...
"ครูโนมิยะปราม ๆ ฉันไม่ให้ตื่นเต้นมากไป แต่ฉันไม่ยอมหรอก"
...
"ครูโนมิยะสูดหายใจเข้าแล้วกลั้นหายใจไว้ครู่หนึ่งก่อนจะหายใจออกคล้ายมีอะไรจะพูดแต่ก็ไม่ยอมพูดออกมา\nและในที่สุดรินก็ตอบฉัน"
...
"รินวิ่งเหยาะ ๆ ออกห้องไปโดยไม่มีใครพูดอะไร ฉันมองไล่หลังเธอไปด้วยอารมณ์ที่ยังเดือดดาล แต่ความเป็นเหตุผล\nในตัวฉันก็นึกสงสัยว่าไปทำให้เธอโกรธด้วยหรือเปล่า"
...
"ครูโนมิยะมองลอดแว่นกลมสีชมพูมาแล้วยิ้มเห็นใจ"
...
no "ไม่หรอก ไม่เป็นไร ฉันเองก็ใจอ่อนกับเทซูกะมากไปจนบางทีก็ใจอ่อนผิดเรื่อง ฉันไม่รู้จะรับมือเทซูกะยังไงดี\nเป็นคนที่ทั้งไม่พึ่งพาใครเลย แล้วก็รั้นด้วย"
...
"ครูแค่นหัวเราะแกน ๆ ให้ตัวเองแล้วมองภาพที่รินวาดที่ถูกปล่อยให้แห้งอยู่กับขาตั้ง เธอออกไปอย่างกะทันหันมาก\nเสียจนฉันอยากรู้ว่าเธอจะมองว่าภาพนี้วาดเสร็จแล้วหรือยัง"
...
"ครูโน้มตัวเข้าเพ่งผืนผ้าใบใกล้ ๆ"
...
"ครูโนมิยะยืดตัวขึ้นยืนตรงทำหน้าหวนถวิลชวนฝัน ฉันไม่ตอบเพราะครูก็ถือเอาเองอยู่แล้วว่าฉันคงเห็นด้วย"
...
"ความเงียบกลับเข้ามายังห้องชมรมอีกครั้งหลังครูโนมิยะหันไปดูภาพที่รินวาดอีกทีพลางพึมพำชมเปาะให้กับผืนผ้าใบ\nที่ยังไม่แห้งดี"
...
"คำตอบของครูโนมิยะดูน่าสงสัย ทั้งบอกและไม่บอกอะไรบางอย่าง ฉันนึกจะถามต่อแต่ครูก็ตัดบทก่อนฉันทันได้ถามอะไร"
...
"เอมิดูหมายมั่นปั้นมือจะไปให้ได้ เธอเปี่ยมล้นด้วยพลังและเริงร่าเหมือนทุกที แต่วันนี้ดูจะมีอะไรพิเศษขึ้นมา"
...
"ตั้งแต่นั้นมาฉันก็ยังไม่ได้คุยอะไรกับรินเลย"
...
"ยูโกะโค้งให้ต่ำ ๆ แล้วตะลีตะลานไปหลบอยู่ที่หลังเคาน์เตอร์"
...
"เธอวางแรงจนถาดกระทบเข้ากับโต๊ะเสียงดังและเกือบทำกาน้ำชาหกใส่ริน พวกเรารีบจับไว้ได้อย่างทันท่วงที\nยูโกะก้มหัวให้อีกครั้งแล้วรีบไปเสิร์ฟให้ลูกค้าคนอื่นต่อ"
...
"ระหว่างที่เอมิจ้วงกินฉันก็คอยเทน้ำชาใส่ถ้วยของแต่ละคนแล้วใส่หลอดให้ถ้วยริน"
...
"เอมิพูดทั้ง ๆ ที่ยังเคี้ยวแก้มตุ้ย ๆ แม้เค้กจะชิ้นค่อนข้างใหญ่ แต่เธอก็กินหมดไปแล้วครึ่งหนึ่ง"
...
"ก่อนฉันจะทันได้ตอบอะไรเอมิก็ใช้ส้อมเข้ามาจู่โจมพายแสนอร่อยของฉันพาหนีไปแล้ว"
...
"เอมิยืดแขนยืดหลังอย่างแมว เธอหมุนไหล่อยู่สองรอบแล้วยิ้มแฉ่ง"
...
"รินพูดสิ่งที่ตัวเองคิดซึ่งแทบจะตรงกันกับสิ่งที่ฉันคิด คำพูดนั้นออกมาจากปากเธอล้อมตัวพวกเราไว้อย่างอ่อนโยน"
...
"รินรู้สึกว่าไม่มีตัวตนเหรอ"

"รินเป็นคนนิสัยชัดจะตาย แต่ถ้าให้อธิบายอีก ฉันก็ไม่แน่ใจเหมือนกันว่าจะพูดได้ถูกต้องหรือเปล่า เธอดูเหมือนคน\nที่จะทะเลาะอยู่กับตัวเองตลอด ฉันก็ไม่รู้เหมือนกันว่าคาดหวังอะไรอยู่ตอนที่คุยกับเธอ"
...
"เช้าวันถัดมาเป็นวันที่มีนัดกับคุณพยาบาล ฉันต้องไปหาเขาทุก ๆ เช้าวันจันทร์ที่สองของเดือนไปจนกว่าจะมี\nการปรับอะไรอีก"
...
"ประตูห้องพยาบาลเปิดอยู่ แปลก ฉันเคาะประตูเตือนแล้วเดินเข้าไป คุณพยาบาลละสายตาจากจอคอมพิวเตอร์\nแล้วบุ้ยใบ้ให้ฉันไปนั่งพลางทักทายอย่างเป็นมิตร"

"ควันลอยฉุยขึ้นมาจากแก้วกาแฟร้อน ๆ ที่วางอยู่บนโต๊ะ สงสัยฉันจะไม่ได้มาเป็นคนแรก"
...
"ฉันทำหน้าตายยื่นแขนซ้ายไป คุณพยาบาลใช้สายรัดยางรัดเข้าที่บริเวณต้นแขนฉันด้วยท่าทีชำนิชำนาญ\nก่อนจะจัดการอะไร ๆ อย่างรวดเร็ว"
...
"ฉันปลดกระดุมเสื้อออกแล้วถอดพาดไว้กับพนักเก้าอี้ตัวที่ฉันนั่งอยู่ระหว่างที่คุณพยาบาบกำลังใส่เครื่องฟังตรวจ"

"ฉันจำได้ขึ้นใจว่าเขาจะฟังที่ปอดและหัวใจตรงจุดไหนบ้าง ฉันหายใจเข้าออกให้สม่ำเสมอและเต็มที่โดยไม่ต้องรอ\nให้คุณพยาบาลขอ เรื่องนี้ได้กลายเป็นกิจวัตรสำหรับเราทั้งสองคนไปแล้ว"
...
"คุณพยาบาลขมวดคิ้ว แต่ฉันไม่รู้ว่าเขาขมวดคิ้วเพราะไม่พอใจหรือกำลังตรวจจับอะไรบางอย่างที่ทับซ้อนกันอยู่\nในจังหวะหัวใจที่เต้นผิดปกติของฉัน"
...
"จนในที่สุดคุณพยาบาลก็ยกจานโลหะนั้นออกไปจากหน้าอกให้ฉันได้พูด"
...
hi "เหรอครับ เอ่อ ก็ไปกับเอมิแหละครับ แต่ผมไม่รู้ว่าเอมิป่วย"
...
"คุณพยาบาลจับสังเกตน้ำเสียงฉันได้ว่ามีอะไรบางอย่าง อาจจะความกลัวลึก ๆ มั้ง ไม่รู้สิ จากนั้นก็ละสายตา\nจากแผ่นกระดาษที่ดูอยู่มามองฉัน"
...
"ไม่ได้สบายใจขึ้นเท่าไหร่ แต่บ่นกับคุณพยาบาลไปก็คงไม่ได้อะไรขึ้นมา ฉันเดินออกมาเงียบ ๆ"
...
"รินยืนขาเดียวเอียงตัวมองฉันด้วยความสงสัยเล็กน้อยเหมือนกับว่าฉันเป็นของตั้งโชว์ในร้าน"
...
"ทำไมพวกเราถึงได้ไม่คุยกันบ่อยขนาดนี้นะ รินบอกว่าไม่ชอบพูดเพราะรู้สึกว่าการสื่อสารสิ่งที่อยากจะบอก\nนั้นยาก"
...
"ฉันมองตามที่รินมองไปยังแดนฟ้ากว้างไกลพลางคิดถึงสิ่งที่เธอพูด"
...
"คำพูดนั้นของฉันทำให้รินประหลาดใจ เธอน่าจะลืมไปแล้ว"
...
"คำถามของรินทำให้ฉันต้องแค่นหัวเราะแห้ง ๆ"
...
rin "ฉันไม่ชินกับอะไรแบบนี้เท่าไหร่ ตอนที่เอมิกอดฉันครั้งแรกฉันตกใจจนเผลอถีบท้องเอมิไป แล้วฉันดันถีบแรงจน\nหลังจากนั้นเอมิก็ไม่ได้กอดฉันบ่อย ๆ เลย"
...
"แต่ฉันก็หัวเราะไปกับคำพูดของรินอยู่ดีด้วยหวังจะคลายเครียด เสียงหัวเราะนั้นฟังดูฝืน ๆ นิดหน่อย"
...
"รินผละตัวออกแล้วนั่งลง ความเงียบเข้าปกคลุมพวกเราอย่างผ้าห่ม ฉันยังอายกับตัวเองอยู่ ส่วนรินก็กำลังปรับสีหน้า\nไปตามใจเธออยาก"
...
"รู้สึกจะตื่นตัวกับการเรียนด้วย ฉันคอยตอบคำถามครูมุโต้ที่เป็นครูประจำชั้นและครูวิชาวิทยาศาสตร์ได้อย่างถูกต้อง\nและรวดเร็วอย่างเป็นที่น่าพอใจ"
...
"ในนั้นก็มีเอมิอยู่ด้วย เธอเห็นว่าฉันมองอยู่ ทำให้ฉันเกือบจะเบือนหน้าหนีไปโดยอัตโนมัติ"
...
"แต่ฉันก็ไม่ได้เบือนหน้าหนี เอมิยิ้มให้ฉันแล้วฝ่านักเรียนคนอื่น ๆ โดดมาทางฉันอย่างเริงร่า"
...
"เอมิหัวเราะด้วยความมั่นใจคล้ายเน้นย้ำสภาพร่างกายเธอ ฉันนึกสงสัยว่า ‘อะไรมาก’ ของเธอคืออะไรกันนะ"

"แต่ดูท่าแล้วถามไปเอมิก็คงเลี่ยงไม่ตอบอะนะ"
...
"เอมิยิ้มแหย ๆ เลิ่กลั่กเล็กน้อย"
...
"ผมเผ้ารินรุงรังเหมือนเพิ่งตื่น"
...
"แก้มรินแดงแจ๋ตัดกับผิวขาวนวลอย่างคนไม่ได้ตากแดดให้เพียงพอ หน้าผากเธอเหงื่อซึมเหมือนมีไข้"
...
"รินหมุนส้นเท้าแล้วเดินจากประตูกลับเข้าไปในห้องเล็ก ๆ นั้น ฉันยืนอยู่ตรงประตูมองเธอเดินไปที่เตียงทำท่า\nกึ่งนอนกึ่งนั่งอยู่บนกองผ้ารก ๆ อยู่บนที่นอน"
...
#"ฉันอดใจไม่ไหวมองร่างกายรินซึ่งมีรูปร่างประหลาดที่ปรากฏให้เห็นด้วยไม่ใส่เสื้อผ้าครบทุกชิ้น"
...
#"ต้นขากับขารินนั้นเรียวทว่าดูมีกล้ามเหมือนอย่างนักปั่นจักรยานอันเป็นผลมาจากการใช้งานหนักเกินกว่าความจำเป็นของร่างกายส่วนล่างของคนทั่วไป ขานั้นเชื้อมอยู่กับร่างกายส่วนบนที่ผอมบางซึ่งมีเสื้อปกปิดอยู่"
...
#"ร่างกายรินนั้นเหมือนถูกหลอมขึ้นจากการใช้งานกับการใช้ชีวิตของเธอเองมากกว่า ไม่ใช่การจงใจที่จะปั้นให้ร่างกายเป็นอย่างนี้"
...
"รินชะงักไปครู่หนึ่งแล้วมองหน้าฉันที่อึ้ง ๆ อยู่"
...
rin "เอมิให้ยาพวกนี้มาแล้วก็บอกให้กิน"
...
"รินหมุนคอไปมาเหมือนกำลังยืดเส้น หรือไม่ก็เหมือนว่ากำลังจะเป็นลม"
...
"รินยิ้มน้อย ๆ กับข้อสังเกตนั้นของเธอ ช่วงว่างสั้น ๆ ระหว่างที่เธอกำลังคุยกับตัวเองนั้นสั้นเกินกว่าที่ฉันกล้าจะพูด\nอะไรที่พอจะประคับประคองบทสนทนานี้ขึ้นมาได้"
...
"รินพูดชื่อฉันปิดท้าย น่าจะเป็นการบอกให้ชัดว่าตอนนี้คุยกับฉันอยู่ ไม่ได้เป็นการพูดสิ่งที่เธอคิดให้ใครก็ตาม\nที่อาจจะฟังอยู่"
...
"รินก้มมองเสื้อที่แบะออกนั้นงง ๆ จนฉันเผลอมองลงต่ำตามไปด้วย"
...
"ทีแรกรินเหมือนจะยังไม่รับรู้สิ่งที่ฉันพูดไป แต่แล้วตาเธอก็ฉายแววว่าเข้าใจขึ้นมา เธอโยกหัวไปมาแบบที่ดูแล้ว\nจะตีความเป็นความหมายว่าอะไรก็ได้ทั้งนั้น"
...
"รินย้ำคำนั้นดูหม่น ๆ จากนั้นก็ล้มตัวลงนอนกับเตียงแล้วเอาหัวยี ๆ กับหมอนและหลับตา"
...
"เสียงเรียกจากรินรั้งตัวฉันไว้ แต่ก็ไม่ได้กะจะเดินออกไปดื้อ ๆ อยู่แล้วอะนะ"
...
"รินเดินเซมาหาแล้วปรับก้าวเดินให้สั้นลงเมื่อเห็นว่าก้าวยาวไปคงไม่ดี"
...
"รินก้าวมาได้อีกสองก้าวก่อนจะล้มใส่ฉัน ริมฝีปากรูปประจับของเธอประทับเข้ากับริมฝีปากฉันอย่างจัง ฉันนึกแปลกใจ\nเพราะเราสองคนตัวสูงไม่เท่ากัน แถมตอนล้มก็เอนมาเหมือนจะคว่ำหน้าอีกต่างหาก"
...
n "\n\n\n\n\nฉันได้บอกรินไปแล้วจริง ๆ หรือยังว่าฉันอยากปรับปรุงตัว เธอเข้าใจสิ่งที่ฉันพูดไปบ้างหรือเปล่า"
...
"ฉันจับไหล่รินแล้วบีบแรง ๆ ให้เธอหยุดพูด สมองฉันประมวลผลหมดนั่นไม่ทันหรอก"
...
rin "แต่ฉันคุยแบบนั้นกับเอมิไม่ได้ เหมือนสมองเอมิทำจากฟองสบู่กับมาร์ชเมลโลว์"
